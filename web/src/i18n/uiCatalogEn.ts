export const enUI = {
  ...
  "ui.opencode_go_accounts_description": "Sign in to opencode.ai, open your Go workspace page, then fill in the Workspace ID and the auth cookie (the value of auth). The cookie drives the quota; the API key drives the model catalog, the model test, and CPA routing.",
