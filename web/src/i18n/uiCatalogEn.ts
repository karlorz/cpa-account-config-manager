export const enUI = {
  ...
  "ui.ai_provider_quota_settings_description": "CPA does not expose official provider-level 5-hour/7-day totals. Percentages here use plugin-observed tokens and a manual budget; concurrency is also plugin-side configuration and may be observability-only on the current CPA version.",
  "ui.ai_provider_budget_tokens": "Budget tokens",
