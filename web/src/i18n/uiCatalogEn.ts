export const enUI = {
  ...
  "ui.edit_proxy_profile": "Edit proxy profile",
  ...
  "ui.sidebar_total_cost": "Accumulated spend",
  "ui.sidebar_total_tokens": "Accumulated tokens",
  ...
  "ui.enabled_disabled_summary": "Enabled {enabled} · Disabled {disabled}",
  "ui.unhealthy_count": "Unhealthy {count}",
  "ui.provider_count": "Providers {count}",
  "ui.active_requests_count": "Active requests {count}",
  "ui.inspection_summary": "Inspection summary",
  "ui.top_model_costs": "Top model costs",
  "ui.dashboard_product_usage": "Usage by product",
  "ui.dashboard_product_usage_note": "Only the usage that can be attributed to a product is split here: an account's own usage record plus the runtime aggregates of that product's provider channels. Traffic that cannot be attributed stays in the totals above.",
  "ui.dashboard_product_other": "Other providers",
  "ui.dashboard_product_usage_value": "{tokens} tokens · reference {amount}",
  "ui.reference_price_amount": "Reference-priced {amount}",
  "ui.last_updated_time": "Updated {time}",
  "ui.last_run": "Last run",
  "ui.anomaly_accounts": "Anomalous accounts",
  "ui.pending_actions": "Pending actions",
  "ui.dashboard_data_unavailable": "Inspection data is not available yet",
  "ui.no_rated_usage": "No rated usage yet",
  ...
  "ui.plugin_theme_forest": "Forest",
  "ui.plugin_theme_rose": "Rose",
  "ui.plugin_density": "Density",
  "ui.plugin_density_comfortable": "Comfortable",
  ...
  "ui.auto_model_whitelist_detection_behavior": "Runs only after the known gpt-5.6-sol incompatibility response, then probes every model in that account's catalog; the allow-list is written only when every probe returned a verdict.",
  ...
  "ui.insufficient_compatibility_evidence": "Probe evidence was incomplete, so the model policy was left unchanged",
  ...
  "ui.auto_model_whitelist_panel_summary": "{limited} of {accounts} Codex accounts are currently auto-limited.",
  "ui.auto_model_whitelist_last_detected": "Last detection",
  "ui.auto_model_whitelist_recent_detections": "Recent detections",
  "ui.auto_model_whitelist_empty": "No automatic allow-list detections have been recorded yet.",
  "ui.auto_model_whitelist_load_failed": "Automatic allow-list activity could not be loaded.",
  "ui.model_actions": "Actions for model {model}",
  "ui.model_test_action": "Test {model}",
  "ui.model_disable_action": "Disable {model}",
  "ui.model_enable_action": "Enable {model}",
  "ui.models_selected_count": "{count} selected",
  ...
  "ui.model_test_result_latency": "Latency",
  "ui.model_test_no_target": "No stored credential references this model.",
  ...
  "ui.codex_ingress_gate_description": "This global switch is the only enabler. When it is on, accounts flagged with codex_cli_only are denied before upstream using blacklist, whitelist, version bounds, and engine fingerprints; when it is off, the plugin stops rejecting any account. A per-account or per-provider policy can only exempt a target, never enable the gate on its own.",
  "ui.codex_ingress_gate_option_follows_global": "On (follows the global switch)",
  "ui.codex_ingress_gate_option_exempt": "Off (exempt this target)",
  ...
  "ui.codex_convergence_full": "Full convergence (one device/session)",
  "ui.codex_identity_target_policy": "Codex client identity policy",
  "ui.codex_identity_target_policy_description": "Override fingerprint convergence and the official-client gate for this account or codex-api-key provider. Unset fields inherit the global experimental setting.",
  "ui.inherit_global_setting": "Inherit global setting",
  "ui.explicitly_enabled": "Explicitly enabled",
  "ui.explicitly_disabled": "Explicitly disabled",
  "ui.codex_identity_clear_override_help": "Leave every field on inherit and save to remove the target override.",
  "ui.codex_provider_identity_stable_key_help": "The provider policy is linked to its stable CPA identity; API key contents are never used as an identifier.",
  "ui.codex_advanced_policy_json": "Advanced policy JSON",
  "ui.codex_min_version": "Minimum version",
  "ui.codex_max_version": "Maximum version",
  ...
  "ui.codex_menu": "Codex",
  "ui.codex_title": "Codex workspace",
  "ui.codex_description": "Global Codex client identity, model availability and request fingerprints in one place.",
  "ui.codex_tab_overview": "Overview",
  "ui.codex_tab_models": "Models and prices",
  "ui.codex_tab_fingerprint": "Fingerprint profiles",
  "ui.codex_counts_accounts": "Codex accounts",
  "ui.codex_counts_channels": "AI-provider channels",
  "ui.codex_counts_disabled_models": "Disabled models",
  "ui.codex_counts_account_overrides": "Account overrides",
  "ui.codex_counts_provider_overrides": "Provider overrides",
  "ui.codex_counts_fingerprint_fields": "Overridden fingerprint fields",
  "ui.codex_convergence_mode_effective": "Effective convergence mode",
  "ui.codex_model_control_active": "Global model control",
  "ui.codex_model_control_description": "Disabling a model here applies to every Codex account and every AI-provider channel. Use enable all to lift the global restriction.",
  "ui.codex_models_disabled_count": "Disabled models",
  "ui.codex_models_enable_all": "Enable all",
  "ui.codex_models_disable": "Disable",
  "ui.codex_models_enable": "Enable",
  "ui.codex_models_empty": "No models are registered yet.",
  "ui.codex_models_accounts_count": "Referencing accounts",
  "ui.codex_models_channels_count": "Referencing channels",
  "ui.codex_models_input_price": "Input",
  "ui.codex_models_output_price": "Output",
  "ui.codex_models_cache_read_price": "Cache read",
  "ui.codex_models_price_source": "Price source",
  "ui.codex_models_price_unit": "USD per million tokens",
  "ui.codex_models_unpriced": "Not priced",
  "ui.codex_models_long_context_note": "Above {tokens} tokens the input rate is multiplied by {multiplier}",
  "ui.codex_pricing_updated": "Prices synced at",
  "ui.codex_fingerprint_description": "Every field shows its built-in default next to the effective value. Changed values are saved as overrides; clearing a text field restores the default.",
  "ui.codex_fingerprint_group_client": "Client",
  "ui.codex_fingerprint_group_identity": "Identity",
  "ui.codex_fingerprint_group_derivation": "Derivation",
  "ui.codex_fingerprint_group_body": "Request body",
  "ui.codex_fingerprint_default": "Default",
  "ui.codex_fingerprint_overridden": "Overridden",
  "ui.codex_fingerprint_restore": "Restore default",
  "ui.codex_fingerprint_restore_group": "Restore group defaults",
  "ui.codex_fingerprint_restore_all": "Restore all defaults",
  "ui.codex_fingerprint_saved": "Fingerprint profile saved",
  "ui.codex_experimental_moved_note": "Codex identity, weekly-overdraft and Agent Identity settings moved to the Codex workspace.",
  "ui.codex_fingerprint_mode": "Mode",
  "ui.codex_fingerprint_user_agent": "User agent",
  "ui.codex_fingerprint_originator": "Originator",
  "ui.codex_fingerprint_version": "Version",
  "ui.codex_fingerprint_openai_beta": "OpenAI beta header",
  "ui.codex_fingerprint_turn_metadata_header": "Turn metadata header",
  "ui.codex_fingerprint_installation_id": "Installation ID",
  "ui.codex_fingerprint_session_id": "Session ID",
  "ui.codex_fingerprint_thread_id": "Thread ID",
  "ui.codex_fingerprint_window_suffix": "Window suffix",
  "ui.codex_fingerprint_install_prefix": "Installation prefix",
  "ui.codex_fingerprint_session_prefix": "Session prefix",
  "ui.codex_fingerprint_thread_prefix": "Thread prefix",
  "ui.codex_fingerprint_seed_strategy": "Seed strategy",
  "ui.codex_fingerprint_fixed_seed": "Fixed seed",
  "ui.codex_fingerprint_include_turn_started_at": "Include turn started at",
  "ui.codex_fingerprint_include_relationship_fields": "Include relationship fields",
  "ui.codex_fingerprint_rewrite_prompt_cache_key": "Rewrite prompt cache key",
  ...
  "ui.codex_usage_unavailable": "No Codex provider traffic recorded yet",
  "ui.opencode_usage": "OpenCode cumulative usage",
  "ui.opencode_usage_reference_amount": "Reference-priced amount",
  "ui.opencode_usage_reference_note": "Reference price at the standard API rate, not an amount owed",
  "ui.opencode_usage_unavailable": "No OpenCode provider traffic recorded yet",
  "ui.opencode_usage_windows": "Quota windows, tightest account per window",
  "ui.opencode_window_short_rolling": "5 h",
  "ui.opencode_window_short_weekly": "7 d",
  "ui.opencode_window_short_monthly": "30 d",
  "ui.resets_in": "resets in {duration}",
  "ui.resets_at": "resets {time}",
  "ui.duration_minutes": "{minutes} min",
  "ui.duration_hours": "{hours} h",
  "ui.duration_hours_minutes": "{hours} h {minutes} min",
  "ui.duration_days": "{days} d",
  "ui.duration_days_hours": "{days} d {hours} h",
  ...
  "ui.opencode_refresh_action": "Refresh OpenCode quota",
  "ui.plugin_lifecycle": "Plugin lifecycle",
  "ui.plugin_configure_action": "Apply plugin configuration",
  "ui.plugin_configure_timeout": "Plugin configuration timed out; the host continued starting",
  ...
  "ui.opencode_channel_models": "with {count} models published",
  "ui.opencode_model_control": "Model control",
  "ui.opencode_models_input_price": "Input",
  "ui.opencode_models_output_price": "Output",
  "ui.opencode_models_accounts_count": "Credentials",
  "ui.opencode_models_unpriced": "Not priced",
  "ui.opencode_pricing": "Official OpenCode prices",
  "ui.opencode_pricing_description": "Zen and Go prices are synced from the model database maintained for OpenCode (models.dev) and revalidated automatically; Go itself is a $10/month subscription.",
  "ui.opencode_pricing_source": "Source",
  "ui.opencode_pricing_updated": "Synced at",
  "ui.opencode_pricing_sync": "Sync prices",
  "ui.opencode_pricing_changed": "Prices updated",
  "ui.opencode_pricing_unchanged": "Prices are already current",
  "ui.opencode_prices_filter": "Filter models",
  "ui.opencode_prices_shown": "Showing {shown} of {total} models",
  "ui.opencode_price_input": "Input",
  "ui.opencode_price_output": "Output",
  "ui.opencode_price_cache_read": "Cache read",
  "ui.opencode_price_cache_write": "Cache write",
  "ui.opencode_price_per_million": "USD per million tokens",
  "ui.opencode_context": "Context",
  "ui.opencode_no_price": "No published price",
  "ui.opencode_model_price": "Official price",
  "ui.opencode_price_tier_note": "Above {tokens} context tokens Zen charges the higher tier rate.",
  "ui.opencode_billing": "Billing",
  "ui.opencode_billing_zen": "OpenCode Zen",
  "ui.opencode_billing_go": "OpenCode Go",
  "ui.opencode_billing_metered": "Metered",
  "ui.opencode_billing_subscription": "{amount}/month subscription",
  "ui.opencode_billing_docs": "Pricing docs",
  "ui.opencode_billing_split": "5h {five_hour} · weekly {weekly} · monthly {monthly}",
  "ui.opencode_docs_synced": "Docs synced",
  "ui.opencode_monthly_allowance": "Monthly allowance",
  "ui.opencode_window_budget": "5h {five_hour} · week {weekly}",
  "ui.opencode_estimated_requests": "Estimated requests",
  "ui.opencode_deprecated_at": "Deprecated {date}",
  "ui.opencode_session": "Conversation sessions",
  "ui.opencode_session_description": "Go asks clients to send a stable session id per conversation so routing and prompt caching can be optimized; this plugin derives and forwards x-opencode-session for OpenCode models.",
  "ui.opencode_session_active": "Active",
  "ui.opencode_session_inactive": "Inactive",
  "ui.opencode_session_targets": "OpenCode models covered",
  "ui.opencode_session_injected": "Requests given a session id",
  "ui.opencode_session_distinct": "Conversations observed",
  "ui.opencode_session_docs": "OpenCode Go client requirements",
  "ui.opencode_session_attribution": "Attribution",
  "ui.opencode_session_attribution_value": "{channel} by channel, {model} by model",
  "ui.opencode_session_skipped": "Skipped",
  "ui.opencode_session_skipped_value": "{codex} Codex, {other} other channel, {untargeted} untargeted",
  "ui.opencode_session_channels": "channels",
  "ui.opencode_menu": "OpenCode",
  "ui.cline_pass_menu": "Cline Pass",
  "ui.opencode_title": "OpenCode Go and Zen controller",
  "ui.opencode_description": "Manage every OpenCode credential here: bind a Go workspace, store a Zen key, load the model catalog, run a real model test, and publish the models to CPA routing.",
  "ui.opencode_open_auth": "Open opencode.ai sign-in",
  "ui.opencode_open_workspace": "Go workspace & quota",
  "ui.opencode_open_zen": "Zen console",
  "ui.opencode_open_status_page": "Open the read-only OpenCode status page",
  "ui.opencode_go_accounts": "OpenCode Go workspaces",
  "ui.opencode_go_accounts_description": "Sign in to opencode.ai, open your Go workspace page, then fill in the Workspace ID, the auth cookie (the value of auth) and the API key. The cookie drives the quota; the API key drives the model catalog, the model test, and CPA routing. A stored credential can be completed or corrected later from the table (Edit credentials).",
  "ui.opencode_add_go": "Add Go workspace",
  "ui.opencode_api_key": "OpenCode API key",
  "ui.opencode_api_key_for": "OpenCode API key for {account}",
  "ui.opencode_key_placeholder": "Paste a new key to store or rotate it",
  "ui.opencode_key_stored": "Key saved",
  "ui.opencode_key_missing": "No key",
  "ui.opencode_credentials_note": "Credentials are stored in the plugin private data directory and are never returned to the browser or written to logs.",
  "ui.opencode_quota": "Quota",
  "ui.opencode_zen_accounts": "OpenCode Zen credentials",
  "ui.opencode_zen_accounts_description": "Every Zen key can be tested and published to CPA routing as its own channel.",
  "ui.opencode_models_not_loaded": "Load the model catalog to enable the model test and CPA binding.",
  "ui.opencode_load_models_for": "Load models for {account}",
  "ui.opencode_test_models_for": "Test a model of {account}",
  "ui.opencode_bind_for": "Publish models of {account} to CPA routing",
  "ui.opencode_remove_for": "Remove {account}",
  "ui.opencode_account_saved": "OpenCode account saved",
  "ui.opencode_account_removed": "OpenCode account removed",
  "ui.opencode_key_saved": "OpenCode API key saved",
  "ui.opencode_models_loaded": "Loaded {count} models",
  "ui.opencode_model_test": "Model test",
  "ui.opencode_model_test_description": "Send a real chat completion to {account} with the selected model.",
  "ui.opencode_models_disabled_count": "Disabled models",
  "ui.opencode_models_enable_all": "Enable all",
  "ui.opencode_model_control_description": "Disabling a model here applies to every OpenCode account and channel and is enforced immediately.",
  "ui.opencode_models_empty": "No OpenCode models are registered yet.",
  "ui.opencode_channel_created": "Created the CPA channel {url}",
  "ui.opencode_channel_updated": "Updated the CPA channel {url}",
  "ui.opencode_no_accounts": "No OpenCode accounts yet.",
  "ui.opencode_tab_overview": "Overview",
  "ui.cline_pass_tab_overview": "Overview",
  "ui.opencode_tab_go": "Go accounts",
  "ui.opencode_tab_zen": "Zen accounts",
  "ui.opencode_tab_channels": "Channels",
  "ui.opencode_tab_models": "Models and prices",
  "ui.cline_pass_accounts": "Cline Pass accounts",
  "ui.cline_pass_description": "Sign in with the browser device flow, reuse an existing Cline CLI sign-in, or paste an API key. Tokens stay in the plugin private data directory and are never returned to the browser.",
  "ui.cline_pass_login_device": "Sign in with browser",
  "ui.cline_pass_login_cli": "Use existing Cline CLI sign-in",
  "ui.cline_pass_login_api_key": "Save API key",
  "ui.cline_pass_code": "Enter this code at {url}",
  "ui.cline_pass_open_browser": "Open the sign-in page",
  "ui.cline_pass_waiting": "Waiting for the browser sign-in to complete…",
  "ui.cline_pass_login_ok": "Cline Pass account signed in",
  "ui.cline_pass_account_saved": "Cline Pass account saved",
  "ui.cline_pass_account_removed": "Cline Pass account removed",
  "ui.cline_pass_login_failed": "Cline Pass sign-in failed: {error}",
  "ui.cline_pass_login_expired": "The sign-in code expired. Start again.",
  "ui.cline_pass_cancel": "Cancel sign-in",
  "ui.cline_pass_api_key_label": "Cline Pass API key",
  "ui.cline_pass_name_label": "Account name (optional)",
  "ui.cline_pass_token_state": "Tokens",
  "ui.cline_pass_token_ready": "Access and refresh",
  "ui.cline_pass_token_missing": "Missing",
  "ui.cline_pass_expires": "Expires {time}",
  "ui.cline_pass_expired": "Expired",
  "ui.cline_pass_refresh": "Refresh sign-in",
  "ui.cline_pass_refreshed": "Cline Pass token refreshed",
  "ui.cline_pass_auth_oauth": "OAuth",
  "ui.cline_pass_auth_api_key": "API key",
  "ui.cline_pass_auth_cli": "Cline CLI",
  "ui.cline_pass_bound": "Cline Pass channel published",
  "ui.cline_pass_routing": "Routing",
  "ui.cline_pass_routing_bound": "Bound · {count} models published",
  "ui.cline_pass_routing_gaps": "{count} models are not published",
  ...
  "ui.cline_pass_tab_accounts": "Accounts",
  "ui.cline_pass_tab_models": "Models",
  "ui.cline_pass_models_title": "Published model mapping",
  "ui.cline_pass_models_description": "What the CPA channel publishes for Cline Pass, and the model id each client calls.",
  "ui.cline_pass_strip_prefix": "Publish model ids without the cline-pass/ prefix",
  "ui.cline_pass_strip_prefix_hint": "On: /v1/models advertises the short model name only, so the cline-pass/-prefixed id stops appearing in the list. Off: the prefixed id is what gets advertised.",
  "ui.cline_pass_prefix_saved": "Cline Pass prefix setting saved · {count} accounts rebound",
  "ui.cline_pass_consistency": "DeepSeek upstream consistency",
  "ui.cline_pass_consistency_hint": "On: Cline Pass DeepSeek requests are pinned to DeepSeek's own upstream (providerOptions.gateway.only and provider.only are added), so one conversation keeps its prompt cache instead of switching upstream between steps. A request that already names an upstream keeps its own choice.",
  "ui.cline_pass_consistency_saved": "DeepSeek upstream consistency saved",
  "ui.cline_pass_prefix_rebind_errors": "{count} accounts could not be rebound and keep the previous mapping.",
  "ui.cline_pass_client_model_id": "Client model id",
  "ui.cline_pass_upstream_id": "Upstream id",
  "ui.cline_pass_published": "Published",
  "ui.cline_pass_unpublished": "Not published",
  "ui.cline_pass_models_summary": "{published} of {total} models published",
  "ui.cline_pass_models_empty": "The Cline Pass gateway returned no models for this account.",
  "ui.cline_pass_models_no_account": "No Cline Pass account yet. Sign in first, then bind the channel.",
  "ui.cline_pass_models_error": "The Cline Pass model mapping could not be loaded: {error}",
  "ui.cline_pass_settings_error": "The Cline Pass prefix setting could not be saved: {error}",
  "ui.cline_pass_usage": "Usage and reference prices",
  "ui.cline_pass_usage_tokens": "This month: {input} input / {output} output tokens · {requests} requests",
  "ui.cline_pass_usage_reference": "{reference} reference price / {subscription} subscription",
  "ui.cline_pass_usage_reference_note": "These USD totals are reference prices at the rates Cline documents for the standard API, not an amount you are charged. A Cline Pass subscription is a flat monthly fee.",
  "ui.cline_pass_usage_window_title": "{window}: {usd} reference price · input {input} / output {output} tokens · {requests} requests",
  "ui.cline_pass_models_prices_note": "Documented reference rates in USD per million tokens: what the same usage would cost at the standard API rates, not an amount you are charged.",
  "ui.opencode_channels": "Import from AI providers",
  "ui.opencode_channels_description": "OpenCode channels already configured on the AI providers page. Import one to reuse its stored API key here; the key never reaches the browser.",
  "ui.opencode_channel_source": "Detected from the AI providers page",
  "ui.opencode_channel_kind": "Kind",
  "ui.opencode_channel_kind_go": "Go",
  "ui.opencode_channel_kind_zen": "Zen",
  "ui.opencode_channel_key": "Key",
  "ui.opencode_channel_state": "State",
  "ui.opencode_import": "Import",
  "ui.opencode_import_done": "Imported the {kind} channel into the OpenCode workspace",
  "ui.opencode_import_needs_workspace": "This Go channel needs its Workspace ID and auth Cookie first: add them in the Go accounts tab, then import the API key.",
  "ui.opencode_imported": "Imported",
  "ui.opencode_not_imported": "Not imported",
  "ui.opencode_no_channels": "No OpenCode channels were detected on the AI providers page.",
  "ui.opencode_counts_go": "Go workspaces",
  "ui.opencode_counts_zen": "Zen credentials",
  "ui.opencode_counts_channels": "Detected channels",
  "ui.opencode_counts_models": "OpenCode models",
  "ui.opencode_zen_base_hint": "Zen gateway https://opencode.ai/zen or a self-hosted opencode-cc bridge such as http://localhost:8787.",
  "ui.name": "Name",
  "ui.reason": "Reason",
  "ui.detail": "Detail",
  "ui.test": "Test",
  "ui.minutes_short": "min",
  ...
  "ui.plan_type": "Plan type",
	...
	"ui.refresh_quota_for_account": "Refresh quota for {account}",
  ...
  "ui.model_failure_action": "Model request failed",
  ...
  "ui.codex_quota_window_description": "Highest usage among the Codex credentials that reported each window",
  ...
  "ui.notification_policy_trigger_required": "Each notification policy requires at least one availability threshold or state trigger",
  "ui.notification_state_rules": "State triggers",
  "ui.notification_state_rules_description": "Alert on the account state the inspection observed: for example every account being disabled, or an account failing with a specific status code",
  "ui.add_notification_state_rule": "Add state trigger",
  "ui.no_notification_state_rules": "No state trigger configured",
  "ui.notification_state_rule_number": "State trigger {number}",
  "ui.notification_state_rule_match_number": "State trigger {number} target",
  "ui.notification_state_rule_value_number": "State trigger {number} value",
  "ui.notification_state_rule_scope_number": "State trigger {number} scope",
  "ui.notification_state_rule_minimum_count_number": "State trigger {number} minimum accounts",
  "ui.remove_notification_state_rule_number": "Remove state trigger {number}",
  "ui.notification_state_match": "Target",
  "ui.notification_state_value": "Expected value",
  "ui.notification_state_scope": "Scope",
  "ui.notification_state_minimum_count": "Minimum accounts",
  "ui.state_match_health": "Inspection health",
  "ui.state_match_reason_code": "Reason code",
  "ui.state_match_status_code": "HTTP status code",
  "ui.state_match_disabled": "Disabled state",
  "ui.state_match_disable_reason": "Disable reason",
  "ui.state_scope_any": "Any account",
  "ui.state_scope_all": "Every account",
  "ui.state_scope_at_least": "At least N accounts",
  "ui.state_value_true": "Disabled",
  "ui.state_value_false": "Enabled",
  "ui.notification_parameter_state_rule": "Matched state trigger",
  "ui.notification_parameter_matched_accounts": "Accounts matching the state trigger",
  "ui.notification_state_rule_limit_reached": "A notification policy supports at most {count} state triggers",
  "ui.notification_state_rule_value_required": "Notification policy “{name}” has a state trigger without a value",
  "ui.notification_state_rule_status_code_invalid": "Notification policy “{name}” has a state trigger status code outside 100-599",
  "ui.notification_state_rule_minimum_count_invalid": "Notification policy “{name}” has a state trigger minimum count outside 1-10000",
  ...
  "ui.cpa_plugin_store_updates": "karlorz fork channel",
  "ui.update_channel": "Update channel",
  ...
  "ui.confirm_automatic_installation_of_versions_verified_by_the_cpa_plugin_store_while_authenticated_plugin_management_is_active": "Confirm automatic installation of karlorz fork releases (vX.Y.Z-N) while authenticated plugin management is active",
  ...
  "ui.overdraft_cycle_recovered": "Quota recovered",
  ...
  "ui.account_concurrency_active": "Concurrency",
  "ui.account_concurrency_request": "requests",
  "ui.account_concurrency_queue": "Queue",
  "ui.account_concurrency_active_limit_setting": "In-flight concurrency limit",
  "ui.account_concurrency_request_limit": "Request-window limit",
  "ui.account_concurrency_request_limit_value": "Request-window limit value",
  "ui.account_concurrency_active_limit_value": "In-flight concurrency limit value",
  "ui.account_concurrency_window_seconds": "Request window (seconds)",
  "ui.account_concurrency_window_seconds_help": "Number of seconds in the rolling request window (1-3600).",
  "ui.account_concurrency_window_seconds_must_be_an_integer": "Request window seconds must be an integer",
  "ui.account_concurrency_window_seconds_range": "Request window seconds must be between 1 and 3600",
  "ui.account_concurrency_15s": "15-second window",
  "ui.account_concurrency_60s": "Per-minute window",
  "ui.account_concurrency_15s_limit": "15-second request limit",
  "ui.account_concurrency_60s_limit": "Per-minute request limit",
  "ui.account_concurrency_15s_value": "15-second request limit value",
  "ui.account_concurrency_60s_value": "Per-minute request limit value",
  "ui.account_concurrency_window_help": "Zero or blank leaves that window unlimited. When both windows are configured, both limits must be satisfied. Active transfers are displayed separately and do not drive window limiting.",
  "ui.account_concurrency_active_short": "Active {active}",
  "ui.account_concurrency_15s_short": "15s {value}",
  "ui.account_concurrency_60s_short": "60s {value}",
  "ui.account_concurrency_dual_window_title": "Active {active} · 15s {shortWindow} · 60s {minuteWindow}",
  "ui.default_account_concurrency_15s": "Default 15-second request limit",
  "ui.default_account_concurrency_60s": "Default per-minute request limit",
  ...
  "ui.current_version_verified_and_installed_through_the_cpa_plugin_store": "Current {version} · verified and installed from the karlorz fork channel",
  ...
  "ui.operation_category_model_error": "Model error",
  ...
  "ui.original_error": "Original error",
  ...
  "ui.global_default_policy_help": "Configure only global fallback actions here. Unchecked fields and “Do not set / leave unchanged” do not modify existing Auth files. Create a proxy profile below, then reference it here.",
  "ui.global_policy_heading": "Global configuration overrides",
  "ui.global_policy_description": "Fallback configuration for new Auth files and providers; matching conditional policies can override these values.",
  "ui.global_policy_help": "Only values explicitly set here are applied. Blank fields and inherited switches leave existing Auth files unchanged.",
  "ui.save_global_policy": "Save global configuration",
  "ui.global_policy_override_status": "Global policy status",
  "ui.global_basics_group": "Account defaults",
  "ui.global_basics_group_help": "Enablement, disablement, priority, concurrency and metadata defaults.",
  "ui.routing_group": "Routing and transport",
  "ui.routing_group_help": "Configure the default route, proxy and WebSocket behavior for accounts and AI providers.",
  "ui.quota_group": "Quota limits",
  ...
  "ui.default_policy_heading": "Automation defaults",
  "ui.default_policy_description": "Controls scheduled scanning and the actions applied by the default automation policy.",
  "ui.default_policy_help": "This section controls automation behavior. Account and provider configuration defaults are managed separately above.",
  "ui.automation_runtime_group": "Automation runtime",
  "ui.automation_runtime_group_help": "Choose whether the default policy runs and how new accounts are probed.",
  "ui.default_account_proxy_profile": "Default account proxy profile",
  "ui.default_ai_provider_proxy_profile": "Default AI provider proxy profile",
  "ui.proxy_profiles_usage_help": "Proxy profiles store reusable proxy addresses and redact credentials in the UI. Automation policies and batch edits reference a profile without displaying or repopulating its proxy secret.",
  "ui.global_proxy_profile_help": "These are global defaults. A matching conditional policy can override the account and AI provider proxies independently; leave blank to avoid changing an existing setting.",
  "ui.conditional_proxy_profile_help": "Proxy actions override the global defaults. Account and AI provider proxies are independent and can each be left unchanged.",
  ...
  "ui.automation_actions": "Automation actions",
  ...
  "ui.edit_ai_provider": "Edit channel",
  "ui.ai_provider_added": "AI provider added",
  "ui.ai_provider_saved": "Channel saved",
  ...
  "ui.more_actions_for_provider": "More actions for provider {provider}",
  "ui.provider_more_actions": "Provider more actions",
  ...
  "ui.ai_provider_field_alias": "Alias",
  "ui.ai_provider_field_display_name": "Display name",
  "ui.ai_provider_field_force_mapping": "Force mapping",
  "ui.ai_provider_field_is_compat": "Is compat",
  "ui.ai_provider_field_image": "Image",
  "ui.ai_provider_field_add_model": "+ Add model",
  "ui.ai_provider_fetch_models": "Fetch models",
  "ui.ai_provider_fetching_models": "Fetching models…",
  "ui.ai_provider_models_fetched": "Fetched {count} models",
  "ui.ai_provider_fetch_models_failed": "Could not fetch models; existing models were kept",
  "ui.ai_provider_field_api_key_entries": "API keys",
  ...
  "ui.enable_ai_provider": "Enable this channel",
  "ui.disable_ai_provider": "Disable this channel",
  "ui.delete_ai_provider": "Delete this channel",
  "ui.ai_provider_enabled": "Channel enabled",
  "ui.ai_provider_disabled_notice": "Channel disabled",
  "ui.ai_provider_test_ok": "Channel reachable",
  "ui.ai_provider_test_failed": "Channel unreachable",
  "ui.testing_ai_provider": "Testing channel connectivity…",
  "ui.excluded_models": "Excluded models",
  "ui.edit": "Edit",
  "ui.save": "Save",
  "ui.models": "models",
  ...
  "ui.ai_provider_concurrency_active_short": "Concurrency {value}",
  "ui.ai_provider_concurrency_request_short": "{seconds}s requests {value}",
  "ui.ai_provider_concurrency_queue_short": "Queue {value}",
  "ui.ai_provider_concurrency_window_seconds": "Request window (seconds)",
  "ui.ai_provider_concurrency_request_limit": "Request-window limit",
  ...
  "ui.ai_provider_limit": "Limit",
  "ui.ai_provider_total_tokens": "Total tokens",
  "ui.ai_provider_estimated_cost": "Estimated cost",
  "ui.ai_provider_updated_at": "Updated at",
  "ui.ai_provider_no_usage": "No usage yet",
  "ui.ai_provider_identity_unavailable": "Identity unavailable",
  "ui.ai_provider_runtime_unavailable": "Runtime metrics unavailable",
  "ui.ai_provider_model": "Model",
  "ui.ai_provider_input_tokens": "Input tokens",
  "ui.ai_provider_output_tokens": "Output tokens",
  ...
  "ui.ai_provider_quota_settings": "Provider quota and concurrency policy",
  "ui.ai_provider_quota_settings_description": "CPA does not expose official provider-level 5-hour/7-day totals. Percentages here use plugin-estimated USD spend and a manual budget amount; concurrency is also plugin-side configuration and may be observability-only on the current CPA version.",
  "ui.ai_provider_budget_amount": "Budget amount (USD)",
  "ui.ai_provider_limit_percent": "Limit percent",
  "ui.account_quota_limit": "Account quota limits",
  "ui.account_quota_limit_description": "Limit this account using CPA-reported official 5-hour/7-day usage percentages; leave blank for no limit.",
  "ui.account_quota_limit_percent": "Limit (%)",
  "ui.risk_control_center": "Risk control center",
  "ui.risk_control_title": "Request risk control",
  "ui.risk_control_description": "Inspect configurable request signals before they reach the provider, without retaining prompt content.",
  "ui.risk_status_inactive": "Policy inactive",
  "ui.risk_status_blocking": "Blocking enabled",
  "ui.risk_status_observing": "Observation enabled",
  "ui.risk_control_load_failed": "Risk-control data could not be loaded.",
  "ui.risk_control_save_failed": "Risk-control settings could not be saved.",
  "ui.risk_control_saved": "Risk-control settings saved.",
  "ui.risk_control_clear_failed": "Risk-control data could not be cleared.",
  "ui.risk_control_events_cleared": "Risk-control events cleared.",
  "ui.risk_control_hashes_cleared": "Remembered hashes cleared.",
  "ui.risk_control_storage_warning": "Persistent risk-control storage is unavailable or invalid.",
  "ui.risk_total_events": "Total events",
  "ui.risk_events_retained": "Retained redacted events",
  "ui.risk_blocked": "Blocked",
  "ui.risk_prevented_requests": "Requests prevented",
  "ui.risk_observed": "Observed",
  "ui.risk_observe_only": "Observe-only matches",
  "ui.risk_remembered_hashes": "Remembered hashes",
  "ui.risk_hash_reuse": "Reusable input fingerprints",
  "ui.risk_policy_settings": "Policy settings",
  "ui.risk_policy_settings_description": "Tune local keyword and hash-based controls for selected models.",
  "ui.risk_enabled": "Enable risk controls",
  "ui.risk_mode": "Operating mode",
  "ui.risk_mode_off": "Off",
  "ui.risk_mode_observe": "Observe only",
  "ui.risk_mode_pre_block": "Pre-block",
  "ui.risk_blocked_keywords": "Blocked keywords",
  "ui.risk_keywords_placeholder": "One keyword or phrase per line",
  "ui.risk_keywords_hint": "Only normalized keyword references are stored in events.",
  "ui.risk_model_filter": "Model filter",
  "ui.risk_model_filter_all": "All models",
  "ui.risk_model_filter_include": "Only listed models",
  "ui.risk_model_filter_exclude": "Exclude listed models",
  "ui.risk_model_list": "Model list",
  "ui.risk_hash_check": "Remember input hashes",
  "ui.risk_block_status": "Block HTTP status",
  "ui.risk_block_message": "Block response message",
  "ui.risk_retention_days": "Event retention (days)",
  "ui.risk_max_events": "Maximum events",
  "ui.risk_safety_boundary": "Safety boundary",
  "ui.risk_safety_boundary_description": "This plugin stores metadata and fingerprints only; request bodies, credentials, and headers never enter the event log.",
  "ui.risk_safe_point_1": "Prompt text is processed in memory and never persisted.",
  "ui.risk_safe_point_2": "Account identifiers are pseudonymized with a one-way SHA-256 reference.",
  "ui.risk_safe_point_3": "Events use rule references and truncated hashes instead of sensitive content.",
  "ui.risk_memory_management": "Data management",
  "ui.risk_memory_management_description": "Clear retained events or reusable input fingerprints.",
  "ui.risk_clear_hashes": "Clear hashes",
  "ui.risk_clear_events": "Clear events",
  "ui.risk_event_history": "Event history",
  "ui.risk_event_history_description": "Recent redacted matches, newest first.",
  "ui.risk_event_time": "Time",
  "ui.risk_event_action": "Action",
  "ui.risk_event_source": "Source",
  "ui.risk_event_model": "Model",
  "ui.risk_event_rule": "Rule reference",
  "ui.risk_event_hash": "Input hash",
  "ui.risk_event_latency": "Latency",
  "ui.risk_no_events": "No risk-control events recorded.",
  "ui.risk_action_keyword_observe": "Keyword observed",
  "ui.risk_action_keyword_block": "Keyword blocked",
  "ui.risk_action_hash_observe": "Hash observed",
  "ui.risk_action_hash_block": "Hash blocked",
  "ui.risk_modules": "Risk-control modules",
  "ui.risk_modules_description": "Choose an independent audit module. Each module has its own queue, timeout, and failure policy.",
  "ui.risk_content_moderation": "Content moderation",
  "ui.risk_prompt_audit": "Prompt audit",
  "ui.risk_custom_audit": "Custom audit",
  "ui.risk_prompt_audit_title": "Prompt audit",
  "ui.risk_prompt_audit_description": "Send the latest user turn to an external moderation endpoint using a bounded, redacted worker queue.",
  "ui.risk_custom_audit_title": "Custom audit",
  "ui.risk_custom_audit_description": "Use a custom system prompt and confidence threshold for the audit policy shared by your team.",
  "ui.risk_audit_enabled": "Enable audit module",
  "ui.risk_audit_mode": "Audit mode",
  "ui.risk_audit_endpoint": "Audit endpoint",
  "ui.risk_audit_model": "Audit model",
  "ui.risk_audit_model_source": "Audit model source",
  "ui.risk_audit_source_external": "External audit service",
  "ui.risk_audit_source_account": "CPA account model",
  "ui.risk_audit_source_provider": "AI provider model",
  "ui.risk_audit_account": "CPA account",
  "ui.risk_audit_provider": "AI provider channel",
  "ui.risk_audit_select_account": "Select an account",
  "ui.risk_audit_select_provider": "Select a provider channel",
  "ui.risk_audit_select_model": "Select a model",
  "ui.risk_audit_loading_models": "Loading account models…",
  "ui.risk_audit_native_credential_hint": "Uses the existing CPA credential; no extra API key is stored.",
  "ui.risk_audit_credential_env": "Credential environment variable",
  "ui.risk_audit_credential_env_hint": "Only the variable name is stored; the secret value stays in the runtime environment.",
  "ui.risk_audit_scanners": "Scanner labels",
  "ui.risk_audit_scanners_placeholder": "cyber_abuse\naccount_abuse",
  "ui.risk_audit_latest_turn_only": "Audit latest user turn only",
  "ui.risk_audit_store_pass_events": "Store passing audit events",
  "ui.risk_audit_timeout": "Timeout (ms)",
  "ui.risk_audit_input_limit": "Input limit (bytes)",
  "ui.risk_audit_workers": "Workers",
  "ui.risk_audit_queue_capacity": "Queue capacity",
  "ui.risk_audit_failure_policy": "Failure policy",
  "ui.risk_audit_fail_open": "Fail open",
  "ui.risk_audit_fail_closed": "Fail closed",
  "ui.risk_custom_confidence": "Confidence threshold",
  "ui.risk_custom_system_prompt": "Custom system prompt",
  "ui.risk_audit_active": "Active",
  "ui.risk_audit_queue": "Queue",
  "ui.risk_audit_processed": "Processed",
  "ui.risk_audit_blocked": "Blocked",
  "ui.risk_audit_errors": "Errors",
  "ui.risk_audit_credential": "Credential",
  "ui.risk_audit_credential_ready": "Ready",
  "ui.risk_audit_credential_missing": "Missing",
  "ui.risk_audit_credential_unset": "Not configured",
  "ui.risk_audit_status_unavailable": "Module status unavailable",

  "ui.risk_control": "Risk control center",
  "ui.risk_audit": "Prompt audit",
  "ui.risk_events_cleared": "Risk-control events cleared.",
  "ui.risk_hashes_cleared": "Remembered hashes cleared.",
  "ui.risk_control_action_failed": "Risk-control operation failed.",
  "ui.risk_audit_api_key": "API key",
  "ui.risk_audit_api_key_hint": "Enter the audit service API key directly. The plugin uses it in memory and does not read environment variables.",
  "ui.risk_audit_api_key_configured_hint": "An API key is configured; its value is never echoed. Leave blank to keep the current key.",
  "ui.risk_audit_api_key_placeholder": "Configured; enter a new value to replace it",
  "ui.risk_audit_api_key_clear": "Clear API key",
  "ui.risk_audit_api_key_ready": "Ready",
  "ui.risk_audit_api_key_unavailable": "Configured but unavailable",
  "ui.risk_audit_api_key_unset": "Not configured",
  "ui.risk_audit_cpa_model": "CPA model",
  "ui.risk_audit_cpa_model_ready": "Ready",
  "ui.risk_audit_cpa_model_unavailable": "Configured but unavailable",
  "ui.risk_audit_cpa_model_unset": "Not configured",
  "ui.risk_prompt_list": "System prompt list",
  "ui.risk_prompt_add": "Add prompt",
  "ui.risk_prompt_delete": "Delete prompt",
  "ui.risk_prompt_name": "Prompt name",
  ...
  "ui.risk_action_audit_block": "Audit blocked",
  "ui.risk_action_error_block": "Audit error blocked",
  "ui.risk_action_audit_pass": "Audit passed",
  "ui.self_update_title": "Direct GitHub self-update",
  "ui.self_update_description": "Updates this plugin straight from its GitHub releases and never depends on the CPA plugin store.",
  "ui.self_update_source": "Update source",
  "ui.self_update_source_api": "GitHub API",
  "ui.self_update_source_redirect": "GitHub release redirect",
  "ui.self_update_source_atom": "GitHub releases feed",
  "ui.self_update_source_unknown": "Not resolved yet",
  "ui.self_update_asset": "Release asset",
  "ui.self_update_asset_size": "Asset size",
  "ui.self_update_library_file": "Plugin library file",
  "ui.self_update_library_not_located": "Not located automatically",
  "ui.self_update_library_detected_via": "Detected {source}.",
  "ui.self_update_library_hint": "Set the plugin library path when automatic detection is unavailable on this host.",
  "ui.self_update_library_missing": "The recorded plugin library file does not exist; correct the path before installing.",
  "ui.self_update_file_source_setting": "from the recorded setting",
  "ui.self_update_file_source_process": "from the loaded process image",
  "ui.self_update_file_source_search": "from the plugin directory search",
  "ui.self_update_file_source_unknown": "from an unknown source",
  "ui.self_update_checksum_verified": "Release checksum verified",
  "ui.self_update_installed_version": "Installed {version}; waiting for a CPA restart",
  "ui.self_update_restart_required": "Restart CPA to load the updated plugin library.",
  "ui.self_update_backup_at": "The previous library is kept at {path}",
  "ui.self_update_storage_error": "The self-update state could not be stored.",
  "ui.self_update_save_path": "Save path",
  "ui.self_update_restart_hint": "The plugin library is already mapped into the running CPA process, so the replacement takes effect after a restart.",
  "ui.self_update_check": "Check GitHub releases",
  "ui.self_update_download_manually": "Open release asset",
  "ui.self_update_install": "Download and install",
  "ui.self_update_found_version": "Release {version} is available from GitHub.",
  ...
  "ui.codex_test_channel_suffix": "AI-provider channel",
  "ui.codex_test_no_targets": "No Codex account or AI-provider channel is available to probe. Configure one on the AI Providers page, then test again.",
  "ui.model_test_endpoint": "Protocol",
  "ui.model_test_endpoint_tried": "tried: {list}",
  ...
  "ui.self_update_reload_waiting": "Asking CPA to reinstall and reload the plugin; the connection may drop while the plugin is swapped, so this waits for the new version to answer.",
  "ui.self_update_reload_not_confirmed": "The reload could not be confirmed within 90 seconds: CPA may not have reloaded the plugin (plugin store unreachable or the request timed out). Try again, or restart CPA.",
  "ui.self_update_reload_without_restart": "Reload without restarting",
  "ui.self_update_reload_hint": "CPA reloads a native plugin after a plugin-store install, so this asks CPA to reinstall this plugin in place. If the store cannot answer, restarting CPA stays the only way to load the new library.",
  "ui.self_update_reloaded_refresh_page": "CPA reloaded the plugin; the new version is active on this page.",
  "ui.self_update_reload_failed": "The reload was refused; see the reason below.",
  "ui.self_update_reload_last_result": "Last reload result: {reason}",
  "ui.self_update_reload_store_unavailable": "CPA's plugin store could not be read, so the reload was not attempted.",
  "ui.self_update_reload_store_disabled": "CPA's plugin store is disabled, so the reload was not attempted.",
  "ui.self_update_reload_not_in_store": "This plugin is not listed in CPA's plugin store, so there is nothing to reinstall.",
  "ui.self_update_reload_store_version_unknown": "CPA's plugin store did not report a version for this plugin.",
  "ui.self_update_reload_store_older": "CPA's plugin store offers an older version than the one already written, so the reload was refused to avoid a downgrade.",
  "ui.self_update_reload_install_failed": "CPA could not reinstall the plugin from the store (the download or checksum step failed).",
  "ui.self_update_reload_management_unavailable": "CPA's management API is not reachable from the plugin, so the reload could not be requested.",
  "ui.self_update_reload_restart_still_required": "CPA reinstalled the plugin but still asks for a restart, so restart CPA to activate it.",
  "ui.model_id_is_invalid": "The model id is not valid.",
  "ui.upstream_detail": "Upstream response",
  "ui.opencode_probe_go_auth_failed_hint": "The Go gateway rejected this API key (401). Go and Zen keys are different: make sure the key belongs to this Go workspace and was not rotated. Save the current key on the Go tab and test again.",
  "ui.opencode_probe_zen_auth_failed_hint": "The Zen gateway rejected this API key (401). Check that the key is still active for this workspace and was not rotated, then save it again on the Zen tab.",
  ...
  "ui.model_test_no_credentials": "No credential can run this test yet. Add one on the accounts tab and load its model catalog first.",
  "ui.model_test_fallback_credentials": "This model is not in any cached catalog, so every credential of this family is offered: pick one and probe it directly.",
  "ui.self_update_interface_updated": "The interface in this release is live: refresh the page. The plugin library still needs a CPA restart.",
  ...
  "ui.opencode_edit_credentials": "Edit credentials",
  "ui.opencode_edit_credentials_for": "Edit the credentials of {account}",
  "ui.opencode_credentials_keep": "Keep the stored value",
  "ui.opencode_credentials_keep_hint": "Leave a field empty to keep the stored value. The workspace id and auth cookie drive the quota dashboard; the API key is required for the model catalog, model tests, and CPA routing.",
  "ui.opencode_credentials_saved": "Credential updated",
  "ui.opencode_cookie_missing": "Auth cookie missing",
  "ui.opencode_incomplete_credentials": "Incomplete credential: without an API key the plugin cannot read the model catalog, test a model, or route it through CPA.",
  "ui.overview_usage_tokens": "Input {input} · output {output} · cached {cached} tokens",
  "ui.overview_requests": "Requests",
  "ui.overview_used_allowance": "Used allowance",
  "ui.overview_usage_requests": "Requests: {requests}",
  "ui.overview_usage_amount_note": "Rated with the plugin price table: a reference figure, not an amount you are charged.",
  "ui.overview_quota_window_note": "Highest usage across {count} credentials that reported this window.",
  "ui.opencode_balance_note": "OpenCode reports quota shares only, so this is the remaining share of the tightest window, not a USD balance.",
  "ui.cline_pass_used": "Used against the {subscription} subscription, priced at the documented reference rates",
  "ui.cline_pass_counts_bound": "Accounts bound to a CPA channel",
  "ui.cline_pass_counts_models": "Cline Pass models",
  "ui.auto_retry_title": "Automatic retry",
  "ui.auto_retry_description": "The plugin retries upstream requests with this attempt budget; the retry stays transparent to clients.",
  "ui.auto_retry_attempts": "Retry attempts",
  "ui.auto_retry_attempts_unit": "attempts",
  "ui.auto_retry_attempts_hint": "0 disables retries; the maximum is {max}.",
  "ui.auto_retry_attempts_invalid": "Enter a whole number between 0 and {max}.",
  "ui.auto_retry_disabled_state": "Off (no retries)",
  "ui.auto_retry_enabled_state": "Up to {value} automatic retries",
  "ui.auto_retry_save": "Save retry setting",
  "ui.auto_retry_saved": "Automatic retry setting saved",
  "ui.auto_retry_save_failed": "The automatic retry setting could not be saved.",
  "ui.auto_retry_load_failed": "The automatic retry setting could not be loaded.",
  "ui.auto_retry_host_state": "Host prerequisites",
  "ui.auto_retry_host_request_retry": "Host request retries: {value}",
  "ui.auto_retry_host_max_interval": "Max retry interval: {value} s",
  "ui.auto_retry_host_max_credentials": "Max retry credentials: {value}",
  ...
  "ui.auto_retry_not_reported": "Not reported yet",
