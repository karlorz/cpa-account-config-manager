...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.overview_priced_amount": "Оцененная сумма",
  ...
  "ui.overview_balance": "Остаток",
  "ui.overview_balance_unavailable": "Для этого продукта остаток не публикуется; доступно только использование выше.",
  ...
  "ui.cline_pass_balance": "Остаток относительно подписки {subscription} по справочным тарифам документации",
