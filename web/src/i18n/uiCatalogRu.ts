...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.opencode_go_accounts_description": "Войдите в opencode.ai, откройте страницу рабочего пространства Go и укажите Workspace ID вместе с cookie auth (значение auth). Cookie даёт квоту, а API-ключ нужен для каталога моделей, теста модели и маршрутизации CPA.",
