...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.edit_proxy_profile": "Изменить профиль прокси",
  ...
  "ui.sidebar_total_cost": "Накопленный расход",
  "ui.sidebar_total_tokens": "Накопленные токены",
  ...
  "ui.total_cost": "Общая стоимость",
  "ui.enabled_disabled_summary": "Включено {enabled} · Отключено {disabled}",
  "ui.unhealthy_count": "С ошибками {count}",
  "ui.provider_count": "Провайдеры {count}",
  "ui.active_requests_count": "Активные запросы {count}",
  "ui.inspection_summary": "Сводка проверки",
  "ui.top_model_costs": "Стоимость моделей",
  "ui.dashboard_product_usage": "Использование по продуктам",
  "ui.dashboard_product_usage_note": "Здесь разделено только то использование, которое можно отнести к продукту: собственная запись об использовании аккаунта плюс агрегаты среды выполнения каналов этого продукта. Неотносимый трафик остаётся в итогах выше.",
  "ui.dashboard_product_other": "Другие провайдеры",
  "ui.dashboard_product_usage_value": "{tokens} токенов · справочная {amount}",
  "ui.reference_price_amount": "Справочная цена {amount}",
  "ui.last_updated_time": "Обновлено {time}",
  "ui.last_run": "Последний запуск",
  "ui.anomaly_accounts": "Аномальные записи",
  "ui.pending_actions": "Ожидают обработки",
  "ui.dashboard_data_unavailable": "Данные проверки пока недоступны",
  "ui.no_rated_usage": "Нет тарифицируемого расхода",
  ...
  "ui.plugin_theme_forest": "Лесная",
  "ui.plugin_theme_rose": "Розовая",
  "ui.plugin_density": "Плотность",
  "ui.plugin_density_comfortable": "Комфортная",
  ...
  "ui.auto_model_whitelist_detection_behavior": "Запускается только после известного ответа о несовместимости gpt-5.6-sol и проверяет каждую модель в каталоге аккаунта; список разрешённых моделей записывается только тогда, когда все проверки дали результат.",
  ...
  "ui.insufficient_compatibility_evidence": "Доказательств проверки недостаточно, политика моделей не изменена",
  ...
  "ui.auto_model_whitelist_panel_summary": "Сейчас автоматически ограничено {limited} из {accounts} аккаунтов Codex.",
  "ui.auto_model_whitelist_last_detected": "Последнее обнаружение",
  "ui.auto_model_whitelist_recent_detections": "Последние обнаружения",
  "ui.auto_model_whitelist_empty": "Записи об автоматическом списке разрешённых моделей ещё не появились.",
  "ui.auto_model_whitelist_load_failed": "Не удалось загрузить данные об автоматическом списке разрешённых моделей.",
  "ui.model_actions": "Действия для модели {model}",
  "ui.model_test_action": "Протестировать {model}",
  "ui.model_disable_action": "Отключить {model}",
  "ui.model_enable_action": "Включить {model}",
  "ui.models_selected_count": "Выбрано: {count}",
  ...
  "ui.model_test_result_latency": "Задержка",
  "ui.model_test_no_target": "Нет сохранённых учётных данных, ссылающихся на эту модель.",
  ...
  "ui.codex_ingress_gate_description": "Глобальный переключатель — единственный включатель. Когда он включен, учетные записи с codex_cli_only запрещаются до upstream по черному списку, белому списку, границам версий и отпечаткам движка; когда он выключен, плагин не отклоняет запросы. Политика учетной записи или провайдера может только освободить объект, но не включить ворота самостоятельно.",
  "ui.codex_ingress_gate_option_follows_global": "Включено (следует глобальному переключателю)",
  "ui.codex_ingress_gate_option_exempt": "Выключено (освободить объект)",
  ...
  "ui.codex_identity_target_policy": "Политика идентификации клиента Codex",
  "ui.codex_identity_target_policy_description": "Переопределяет сходимость отпечатка и входной шлюз официального клиента для этой учетной записи или провайдера codex-api-key. Неуказанные поля наследуют глобальные экспериментальные настройки.",
  "ui.inherit_global_setting": "Наследовать глобальную настройку",
  "ui.explicitly_enabled": "Явно включено",
  "ui.explicitly_disabled": "Явно отключено",
  "ui.codex_identity_clear_override_help": "Оставьте все поля в режиме наследования и сохраните, чтобы удалить переопределение.",
  "ui.codex_provider_identity_stable_key_help": "Политика провайдера связана с его стабильным идентификатором CPA; содержимое API Key не используется как идентификатор.",
  "ui.codex_advanced_policy_json": "Расширенный JSON политики",
  "ui.codex_min_version": "Минимальная версия",
  "ui.codex_max_version": "Максимальная версия",
  ...
  "ui.codex_menu": "Codex",
  "ui.codex_title": "Рабочая область Codex",
  "ui.codex_description": "Глобальная идентичность клиента Codex, доступность моделей и отпечатки запросов в одном месте.",
  "ui.codex_tab_overview": "Обзор",
  "ui.codex_tab_models": "Модели и цены",
  "ui.codex_tab_fingerprint": "Профили отпечатков",
  "ui.codex_counts_accounts": "Аккаунты Codex",
  "ui.codex_counts_channels": "Каналы AI-провайдеров",
  "ui.codex_counts_disabled_models": "Отключённые модели",
  "ui.codex_counts_account_overrides": "Переопределения аккаунтов",
  "ui.codex_counts_provider_overrides": "Переопределения провайдеров",
  "ui.codex_counts_fingerprint_fields": "Переопределённые поля отпечатка",
  "ui.codex_convergence_mode_effective": "Действующий режим сходимости",
  "ui.codex_model_control_active": "Глобальное управление моделями",
  "ui.codex_model_control_description": "Отключение модели здесь действует на все аккаунты Codex и все каналы AI-провайдеров. Кнопка «включить все» снимает глобальное ограничение.",
  "ui.codex_models_disabled_count": "Отключённые модели",
  "ui.codex_models_enable_all": "Включить все",
  "ui.codex_models_disable": "Отключить",
  "ui.codex_models_enable": "Включить",
  "ui.codex_models_empty": "Модели ещё не зарегистрированы.",
  "ui.codex_models_accounts_count": "Ссылающихся аккаунтов",
  "ui.codex_models_channels_count": "Ссылающихся каналов",
  "ui.codex_models_input_price": "Ввод",
  "ui.codex_models_output_price": "Вывод",
  "ui.codex_models_cache_read_price": "Чтение кэша",
  "ui.codex_models_price_source": "Источник цен",
  "ui.codex_models_price_unit": "USD за миллион токенов",
  "ui.codex_models_unpriced": "Цена не найдена",
  "ui.codex_models_long_context_note": "После {tokens} токенов цена ввода умножается на {multiplier}",
  "ui.codex_pricing_updated": "Цены синхронизированы",
  "ui.codex_fingerprint_description": "Для каждого поля рядом с действующим значением показано встроенное значение по умолчанию. Изменённые значения сохраняются как переопределения; очистка текстового поля возвращает значение по умолчанию.",
  "ui.codex_fingerprint_group_client": "Клиент",
  "ui.codex_fingerprint_group_identity": "Идентичность",
  "ui.codex_fingerprint_group_derivation": "Производные",
  "ui.codex_fingerprint_group_body": "Тело запроса",
  "ui.codex_fingerprint_default": "По умолчанию",
  "ui.codex_fingerprint_overridden": "Переопределено",
  "ui.codex_fingerprint_restore": "Вернуть по умолчанию",
  "ui.codex_fingerprint_restore_group": "Вернуть значения группы",
  "ui.codex_fingerprint_restore_all": "Вернуть все значения по умолчанию",
  "ui.codex_fingerprint_saved": "Профиль отпечатка сохранён",
  "ui.codex_experimental_moved_note": "Настройки идентичности Codex, продолжения квоты и Agent Identity перенесены в рабочую область Codex.",
  "ui.codex_fingerprint_mode": "Режим",
  "ui.codex_fingerprint_user_agent": "User agent",
  "ui.codex_fingerprint_originator": "Originator",
  "ui.codex_fingerprint_version": "Версия",
  "ui.codex_fingerprint_openai_beta": "Заголовок OpenAI beta",
  "ui.codex_fingerprint_turn_metadata_header": "Заголовок turn metadata",
  "ui.codex_fingerprint_installation_id": "ID установки",
  "ui.codex_fingerprint_session_id": "ID сессии",
  "ui.codex_fingerprint_thread_id": "ID потока",
  "ui.codex_fingerprint_window_suffix": "Суффикс окна",
  "ui.codex_fingerprint_install_prefix": "Префикс установки",
  "ui.codex_fingerprint_session_prefix": "Префикс сессии",
  "ui.codex_fingerprint_thread_prefix": "Префикс потока",
  "ui.codex_fingerprint_seed_strategy": "Стратегия seed",
  "ui.codex_fingerprint_fixed_seed": "Фиксированный seed",
  "ui.codex_fingerprint_include_turn_started_at": "Включать turn started at",
  "ui.codex_fingerprint_include_relationship_fields": "Включать поля связей",
  "ui.codex_fingerprint_rewrite_prompt_cache_key": "Перезаписывать prompt cache key",
  ...
  "ui.codex_usage_unavailable": "Трафик провайдера Codex пока не зафиксирован",
  "ui.opencode_usage": "Суммарное использование OpenCode",
  "ui.opencode_usage_reference_amount": "Сумма по справочным ценам",
  "ui.opencode_usage_reference_note": "Справочная цена по стандартному тарифу API, а не сумма к оплате",
  "ui.opencode_usage_unavailable": "Трафик провайдера OpenCode пока не зафиксирован",
  "ui.opencode_usage_windows": "Окна квоты: самый нагруженный аккаунт в каждом окне",
  "ui.opencode_window_short_rolling": "5 ч",
  "ui.opencode_window_short_weekly": "7 дн",
  "ui.opencode_window_short_monthly": "30 дн",
  "ui.resets_in": "сброс через {duration}",
  "ui.resets_at": "сброс {time}",
  "ui.duration_minutes": "{minutes} мин",
  "ui.duration_hours": "{hours} ч",
  "ui.duration_hours_minutes": "{hours} ч {minutes} мин",
  "ui.duration_days": "{days} дн",
  "ui.duration_days_hours": "{days} дн {hours} ч",
  ...
  "ui.plugin_lifecycle": "\u0416\u0438\u0437\u043d\u0435\u043d\u043d\u044b\u0439 \u0446\u0438\u043a\u043b \u043f\u043b\u0430\u0433\u0438\u043d\u0430",
  "ui.plugin_configure_action": "\u041f\u0440\u0438\u043c\u0435\u043d\u0438\u0442\u044c \u043a\u043e\u043d\u0444\u0438\u0433\u0443\u0440\u0430\u0446\u0438\u044e \u043f\u043b\u0430\u0433\u0438\u043d\u0430",
  "ui.plugin_configure_timeout": "\u0412\u0440\u0435\u043c\u044f \u043d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438 \u043f\u043b\u0430\u0433\u0438\u043d\u0430 \u0438\u0441\u0442\u0435\u043a\u043b\u043e; \u0445\u043e\u0441\u0442 \u043f\u0440\u043e\u0434\u043e\u043b\u0436\u0438\u043b \u0437\u0430\u043f\u0443\u0441\u043a",
  ...
  "ui.opencode_channel_models": "опубликовано моделей: {count}",
  "ui.opencode_model_control": "Управление моделями",
  "ui.opencode_models_input_price": "Ввод",
  "ui.opencode_models_output_price": "Вывод",
  "ui.opencode_models_accounts_count": "Учётные данные",
  "ui.opencode_models_unpriced": "Цена не найдена",
  "ui.opencode_pricing": "Официальные цены OpenCode",
  "ui.opencode_pricing_description": "Цены Zen и Go синхронизируются из базы моделей OpenCode (models.dev) и регулярно перепроверяются; сам Go — это подписка за $10 в месяц.",
  "ui.opencode_pricing_source": "Источник",
  "ui.opencode_pricing_updated": "Синхронизировано",
  "ui.opencode_pricing_sync": "Обновить цены",
  "ui.opencode_pricing_changed": "Цены обновлены",
  "ui.opencode_pricing_unchanged": "Цены уже актуальны",
  "ui.opencode_prices_filter": "Фильтр моделей",
  "ui.opencode_prices_shown": "Показано {shown} из {total} моделей",
  "ui.opencode_price_input": "Ввод",
  "ui.opencode_price_output": "Вывод",
  "ui.opencode_price_cache_read": "Чтение кэша",
  "ui.opencode_price_cache_write": "Запись кэша",
  "ui.opencode_price_per_million": "USD за миллион токенов",
  "ui.opencode_context": "Контекст",
  "ui.opencode_no_price": "Опубликованной цены нет",
  "ui.opencode_model_price": "Официальная цена",
  "ui.opencode_price_tier_note": "После {tokens} токенов контекста Zen применяет повышенный тариф.",
  "ui.opencode_billing": "Биллинг",
  "ui.opencode_billing_zen": "OpenCode Zen",
  "ui.opencode_billing_go": "OpenCode Go",
  "ui.opencode_billing_metered": "Оплата по мере использования",
  "ui.opencode_billing_subscription": "Подписка {amount}/месяц",
  "ui.opencode_billing_docs": "Документация по ценам",
  "ui.opencode_billing_split": "5 ч {five_hour} · неделя {weekly} · месяц {monthly}",
  "ui.opencode_docs_synced": "Документы синхронизированы",
  "ui.opencode_monthly_allowance": "Месячный лимит",
  "ui.opencode_window_budget": "5 ч {five_hour} · неделя {weekly}",
  "ui.opencode_estimated_requests": "Оценка запросов",
  "ui.opencode_deprecated_at": "Устарело {date}",
  "ui.opencode_session": "Сессии диалогов",
  "ui.opencode_session_description": "Go просит клиентов отправлять стабильный идентификатор сессии для каждого диалога, чтобы оптимизировать маршрутизацию и кэш подсказок; плагин формирует и передаёт x-opencode-session для моделей OpenCode.",
  "ui.opencode_session_active": "Активна",
  "ui.opencode_session_inactive": "Неактивна",
  "ui.opencode_session_targets": "Покрытые модели OpenCode",
  "ui.opencode_session_injected": "Запросов с идентификатором сессии",
  "ui.opencode_session_distinct": "Замечено диалогов",
  "ui.opencode_session_docs": "Требования к клиентам OpenCode Go",
  "ui.opencode_session_attribution": "Определение",
  "ui.opencode_session_attribution_value": "{channel} по каналу, {model} по модели",
  "ui.opencode_session_skipped": "Пропущено",
  "ui.opencode_session_skipped_value": "Codex {codex}, другой канал {other}, вне списка {untargeted}",
  "ui.opencode_session_channels": "каналов",
  "ui.opencode_menu": "OpenCode",
  "ui.cline_pass_menu": "Cline Pass",
  "ui.opencode_title": "Контроллер OpenCode Go и Zen",
  "ui.opencode_description": "Здесь управляются все учётные данные OpenCode: привязка рабочего пространства Go, ключ Zen, каталог моделей, реальный тест модели и публикация моделей в маршрутизацию CPA.",
  "ui.opencode_open_auth": "Открыть страницу входа opencode.ai",
  "ui.opencode_open_workspace": "Рабочее пространство и квота Go",
  "ui.opencode_open_zen": "Консоль Zen",
  "ui.opencode_open_status_page": "Открыть страницу состояния OpenCode (только чтение)",
  "ui.opencode_go_accounts": "Рабочие пространства OpenCode Go",
  "ui.opencode_go_accounts_description": "Войдите в opencode.ai, откройте страницу рабочего пространства Go и укажите Workspace ID, cookie auth (значение auth) и API-ключ. Cookie даёт квоту, а API-ключ нужен для каталога моделей, теста модели и маршрутизации CPA. Сохранённые данные доступа можно дополнить или исправить в таблице («Изменить данные доступа»).",
  "ui.opencode_add_go": "Добавить рабочее пространство",
  "ui.opencode_api_key": "API-ключ OpenCode",
  "ui.opencode_api_key_for": "API-ключ OpenCode для {account}",
  "ui.opencode_key_placeholder": "Вставьте новый ключ, чтобы сохранить или сменить",
  "ui.opencode_key_stored": "Ключ сохранён",
  "ui.opencode_key_missing": "Ключ не задан",
  "ui.opencode_credentials_note": "Учётные данные хранятся в приватном каталоге плагина и никогда не возвращаются в браузер и не попадают в журналы.",
  "ui.opencode_quota": "Квота",
  "ui.opencode_zen_accounts": "Учётные данные OpenCode Zen",
  "ui.opencode_zen_accounts_description": "Каждый ключ Zen можно протестировать и опубликовать в маршрутизацию CPA отдельным каналом.",
  "ui.opencode_models_not_loaded": "Загрузите каталог моделей, чтобы включить тест модели и привязку CPA.",
  "ui.opencode_load_models_for": "Загрузить модели для {account}",
  "ui.opencode_test_models_for": "Протестировать модель {account}",
  "ui.opencode_bind_for": "Опубликовать модели {account} в маршрутизации CPA",
  "ui.opencode_remove_for": "Удалить {account}",
  "ui.opencode_account_saved": "Учётная запись OpenCode сохранена",
  "ui.opencode_account_removed": "Учётная запись OpenCode удалена",
  "ui.opencode_key_saved": "API-ключ OpenCode сохранён",
  "ui.opencode_models_loaded": "Загружено моделей: {count}",
  "ui.opencode_model_test": "Тест модели",
  "ui.opencode_model_test_description": "Отправляет реальный запрос chat completion в {account} с выбранной моделью.",
  "ui.opencode_models_disabled_count": "Отключённые модели",
  "ui.opencode_models_enable_all": "Включить все",
  "ui.opencode_model_control_description": "Отключение модели здесь действует на все аккаунты и каналы OpenCode и применяется немедленно.",
  "ui.opencode_models_empty": "Модели OpenCode пока не зарегистрированы.",
  "ui.opencode_channel_created": "Канал CPA создан: {url}",
  "ui.opencode_channel_updated": "Канал CPA обновлён: {url}",
  "ui.opencode_no_accounts": "Учётных записей OpenCode пока нет.",
  "ui.opencode_tab_overview": "Обзор",
  "ui.cline_pass_tab_overview": "Обзор",
  "ui.opencode_tab_go": "Учётные записи Go",
  "ui.opencode_tab_zen": "Учётные записи Zen",
  "ui.opencode_tab_channels": "Каналы",
  "ui.opencode_tab_models": "Модели и цены",
  "ui.cline_pass_accounts": "Учётные записи Cline Pass",
  "ui.cline_pass_description": "Войдите через браузер по коду устройства, используйте существующий вход Cline CLI или вставьте API-ключ. Токены хранятся в приватном каталоге плагина и никогда не возвращаются в браузер.",
  "ui.cline_pass_login_device": "Войти через браузер",
  "ui.cline_pass_login_cli": "Использовать вход Cline CLI",
  "ui.cline_pass_login_api_key": "Сохранить API-ключ",
  "ui.cline_pass_code": "Введите этот код на {url}",
  "ui.cline_pass_open_browser": "Открыть страницу входа",
  "ui.cline_pass_waiting": "Ожидание завершения входа в браузере…",
  "ui.cline_pass_login_ok": "Учётная запись Cline Pass подключена",
  "ui.cline_pass_account_saved": "Учётная запись Cline Pass сохранена",
  "ui.cline_pass_account_removed": "Учётная запись Cline Pass удалена",
  "ui.cline_pass_login_failed": "Не удалось войти в Cline Pass: {error}",
  "ui.cline_pass_login_expired": "Срок действия кода входа истёк. Начните заново.",
  "ui.cline_pass_cancel": "Отменить вход",
  "ui.cline_pass_api_key_label": "API-ключ Cline Pass",
  "ui.cline_pass_name_label": "Имя учётной записи (необязательно)",
  "ui.cline_pass_token_state": "Токены",
  "ui.cline_pass_token_ready": "Доступ и обновление",
  "ui.cline_pass_token_missing": "Отсутствуют",
  "ui.cline_pass_expires": "Истекает {time}",
  "ui.cline_pass_expired": "Истёк",
  "ui.cline_pass_refresh": "Обновить вход",
  "ui.cline_pass_refreshed": "Токен Cline Pass обновлён",
  "ui.cline_pass_auth_oauth": "OAuth",
  "ui.cline_pass_auth_api_key": "API-ключ",
  "ui.cline_pass_auth_cli": "Cline CLI",
  "ui.cline_pass_bound": "Канал Cline Pass опубликован",
  "ui.cline_pass_routing": "Маршрутизация",
  ...
  "ui.cline_pass_quota_limited": "Временно отключён (лимит)",
  "ui.cline_pass_quota_limited_hint": "Шлюз ответил 429 и назвал момент сброса окна; до {time} запросы идут через другой аккаунт того же шлюза, затем маршрутизация возвращается к этому.",
  ...
  "ui.cline_pass_tab_accounts": "Аккаунты",
  "ui.cline_pass_tab_models": "Модели",
  "ui.cline_pass_models_title": "Опубликованное сопоставление моделей",
  "ui.cline_pass_models_description": "Что канал CPA публикует для Cline Pass и какой идентификатор модели вызывает каждый клиент.",
  "ui.cline_pass_strip_prefix": "Публиковать идентификаторы моделей без префикса cline-pass/",
  "ui.cline_pass_strip_prefix_hint": "Вкл.: /v1/models публикует только короткое имя модели, идентификатор с префиксом cline-pass/ больше не появляется в списке. Выкл.: публикуется идентификатор с префиксом cline-pass/.",
  "ui.cline_pass_prefix_saved": "Настройка префикса Cline Pass сохранена · перепривязано аккаунтов: {count}",
  "ui.cline_pass_consistency": "Согласованность вышестоящего провайдера DeepSeek",
  "ui.cline_pass_consistency_hint": "Вкл.: запросы DeepSeek через Cline Pass жёстко привязываются к вышестоящему провайдеру самого DeepSeek (добавляются providerOptions.gateway.only и provider.only), чтобы один диалог сохранял кэш промпта, а не переключался между провайдерами между шагами. Запрос, который уже указал провайдера, не изменяется.",
  "ui.cline_pass_consistency_saved": "Настройка согласованности вышестоящего провайдера DeepSeek сохранена",
  "ui.cline_pass_prefix_rebind_errors": "Не удалось перепривязать аккаунтов: {count}; они сохранят прежнее сопоставление.",
  "ui.cline_pass_client_model_id": "Идентификатор модели у клиента",
  "ui.cline_pass_upstream_id": "ID вышестоящей модели",
  "ui.cline_pass_published": "Опубликована",
  "ui.cline_pass_unpublished": "Не опубликована",
  "ui.cline_pass_models_summary": "Опубликовано моделей: {published} из {total}",
  "ui.cline_pass_models_empty": "Шлюз Cline Pass не вернул ни одной модели для этой учётной записи.",
  "ui.cline_pass_models_no_account": "Учётной записи Cline Pass пока нет. Сначала войдите, затем привяжите канал.",
  "ui.cline_pass_models_error": "Не удалось загрузить сопоставление моделей Cline Pass: {error}",
  "ui.cline_pass_settings_error": "Не удалось сохранить настройку префикса Cline Pass: {error}",
  "ui.cline_pass_usage": "Использование и справочные цены",
  "ui.cline_pass_usage_tokens": "За месяц: ввод {input} / вывод {output} токенов · {requests} запросов",
  "ui.cline_pass_usage_reference": "Справочная цена {reference} / подписка {subscription}",
  "ui.cline_pass_usage_reference_note": "Эти суммы в USD — справочные цены по опубликованным стандартным тарифам API Cline, а не фактическая плата. Подписка Cline Pass — фиксированная месячная плата.",
  "ui.cline_pass_usage_window_title": "{window}: справочная цена {usd} · ввод {input} / вывод {output} токенов · {requests} запросов",
  "ui.cline_pass_models_prices_note": "Опубликованные справочные тарифы в USD за миллион токенов: справочная цена того же объёма по стандартным тарифам API, а не фактическая плата.",
  "ui.opencode_channels": "Импорт от поставщиков ИИ",
  "ui.opencode_channels_description": "Каналы OpenCode, уже настроенные на странице поставщиков ИИ. Импортируйте канал, чтобы использовать его сохранённый API-ключ; ключ не попадает в браузер.",
  "ui.opencode_channel_source": "Обнаружено на странице поставщиков ИИ",
  "ui.opencode_channel_kind": "Тип",
  "ui.opencode_channel_kind_go": "Go",
  "ui.opencode_channel_kind_zen": "Zen",
  "ui.opencode_channel_key": "Ключ",
  "ui.opencode_channel_state": "Состояние",
  "ui.opencode_import": "Импорт",
  "ui.opencode_import_done": "Канал {kind} импортирован в рабочую область OpenCode",
  "ui.opencode_import_needs_workspace": "Для этого канала Go сначала нужны Workspace ID и auth Cookie: добавьте их на вкладке «Учётные записи Go», затем импортируйте API-ключ.",
  "ui.opencode_imported": "Импортирован",
  "ui.opencode_not_imported": "Не импортирован",
  "ui.opencode_no_channels": "На странице поставщиков ИИ каналы OpenCode не обнаружены.",
  "ui.opencode_counts_go": "Рабочие области Go",
  "ui.opencode_counts_zen": "Учётные данные Zen",
  "ui.opencode_counts_channels": "Обнаруженные каналы",
  "ui.opencode_counts_models": "Модели OpenCode",
  "ui.opencode_zen_base_hint": "Шлюз Zen https://opencode.ai/zen или собственный мост opencode-cc, например http://localhost:8787.",
  "ui.name": "Имя",
  "ui.reason": "Причина",
  "ui.detail": "Подробности",
  "ui.test": "Тест",
  "ui.minutes_short": "мин",
  ...
  "ui.plan_type": "Тип плана",
	...
	"ui.refresh_quota_for_account": "Обновить квоту для {account}",
  ...
  "ui.1_day_usage": "Использование за 1 день",
  "ui.7_day_usage": "Использование за 7 дней",
  "ui.30_day_usage": "Использование за 30 дней",
  "ui.time": "Время",
  ...
  "ui.model_failure_action": "Сбой запроса к модели",
  ...
  "ui.codex_quota_window_description": "Наибольшее использование среди аккаунтов Codex, сообщивших это окно",
  ...
  "ui.notification_policy_trigger_required": "В каждой политике должен быть включён хотя бы один порог доступности или триггер состояния",
  "ui.notification_state_rules": "Триггеры состояния",
  "ui.notification_state_rules_description": "Оповещение по состоянию аккаунтов, которое увидела проверка: например все аккаунты отключены или аккаунт отвечает определённым кодом состояния",
  "ui.add_notification_state_rule": "Добавить триггер состояния",
  "ui.no_notification_state_rules": "Триггер состояния не настроен",
  "ui.notification_state_rule_number": "Триггер состояния {number}",
  "ui.notification_state_rule_match_number": "Цель триггера состояния {number}",
  "ui.notification_state_rule_value_number": "Значение триггера состояния {number}",
  "ui.notification_state_rule_scope_number": "Область триггера состояния {number}",
  "ui.notification_state_rule_minimum_count_number": "Минимум аккаунтов триггера состояния {number}",
  "ui.remove_notification_state_rule_number": "Удалить триггер состояния {number}",
  "ui.notification_state_match": "Цель",
  "ui.notification_state_value": "Ожидаемое значение",
  "ui.notification_state_scope": "Область",
  "ui.notification_state_minimum_count": "Минимум аккаунтов",
  "ui.state_match_health": "Состояние проверки",
  "ui.state_match_reason_code": "Код причины",
  "ui.state_match_status_code": "Код состояния HTTP",
  "ui.state_match_disabled": "Состояние отключения",
  "ui.state_match_disable_reason": "Причина отключения",
  "ui.state_scope_any": "Любой аккаунт",
  "ui.state_scope_all": "Все аккаунты",
  "ui.state_scope_at_least": "Не менее N аккаунтов",
  "ui.state_value_true": "Отключён",
  "ui.state_value_false": "Включён",
  "ui.notification_parameter_state_rule": "Сработавший триггер состояния",
  "ui.notification_parameter_matched_accounts": "Аккаунтов под триггером состояния",
  "ui.notification_state_rule_limit_reached": "Политика поддерживает не более {count} триггеров состояния",
  "ui.notification_state_rule_value_required": "У триггера состояния политики «{name}» нет значения",
  "ui.notification_state_rule_status_code_invalid": "Код состояния триггера политики «{name}» вне диапазона 100-599",
  "ui.notification_state_rule_minimum_count_invalid": "Минимум аккаунтов триггера политики «{name}» вне диапазона 1-10000",
  ...
  "ui.cpa_plugin_store_updates": "Канал форка karlorz",
  "ui.update_channel": "Канал обновлений",
  ...
  "ui.confirm_automatic_installation_of_versions_verified_by_the_cpa_plugin_store_while_authenticated_plugin_management_is_active": "Подтвердите автоматическую установку выпусков форка karlorz (vX.Y.Z-N), пока активно авторизованное управление плагином",
  ...
  "ui.overdraft_cycle_recovered": "Квота восстановлена",
  ...
  "ui.account_concurrency_active": "Параллельность",
  "ui.account_concurrency_request": "запросы",
  "ui.account_concurrency_queue": "Очередь",
  "ui.account_concurrency_active_limit_setting": "Лимит одновременных запросов в работе",
  "ui.account_concurrency_request_limit": "Лимит окна запросов",
  "ui.account_concurrency_request_limit_value": "Значение лимита окна запросов",
  "ui.account_concurrency_active_limit_value": "Значение лимита одновременных запросов",
  "ui.account_concurrency_window_seconds": "Окно запросов (секунды)",
  "ui.account_concurrency_window_seconds_help": "Длительность скользящего окна запросов: 1-3600 секунд.",
  "ui.account_concurrency_window_seconds_must_be_an_integer": "Длительность окна должна быть целым числом",
  "ui.account_concurrency_window_seconds_range": "Длительность окна должна быть от 1 до 3600 секунд",
  "ui.account_concurrency_15s": "Окно 15 секунд",
  "ui.account_concurrency_60s": "Минутное окно",
  "ui.account_concurrency_15s_limit": "Лимит запросов за 15 секунд",
  "ui.account_concurrency_60s_limit": "Лимит запросов в минуту",
  "ui.account_concurrency_15s_value": "Значение лимита за 15 секунд",
  "ui.account_concurrency_60s_value": "Значение лимита в минуту",
  "ui.account_concurrency_window_help": "Ноль или пустое значение отключает лимит окна. Если настроены оба окна, должны соблюдаться оба лимита. Активные передачи отображаются отдельно и не используются для ограничения окон.",
  "ui.account_concurrency_active_short": "Активно {active}",
  "ui.account_concurrency_15s_short": "15 с {value}",
  "ui.account_concurrency_60s_short": "60 с {value}",
  "ui.account_concurrency_dual_window_title": "Активно {active} · 15 с {shortWindow} · 60 с {minuteWindow}",
  "ui.default_account_concurrency_15s": "Лимит по умолчанию за 15 секунд",
  "ui.default_account_concurrency_60s": "Лимит по умолчанию в минуту",
  ...
  "ui.current_version_verified_and_installed_through_the_cpa_plugin_store": "Текущая {version} · проверена и установлена через канал форка karlorz",
  ...
  "ui.operation_category_model_error": "Ошибка модели",
  ...
  "ui.attempts": "Попытки",
  "ui.original_error": "Исходная ошибка",
  ...
  "ui.global_default_policy_help": "Здесь задаются только глобальные резервные действия. Непомеченные поля и «Не задавать / оставить без изменений» не изменяют существующие файлы Auth. Создайте пресет прокси ниже и выберите его здесь.",
  "ui.global_policy_heading": "Глобальные переопределения конфигурации",
  "ui.global_policy_description": "Резервная конфигурация для новых Auth-файлов и провайдеров; условные политики могут её переопределить.",
  "ui.global_policy_help": "Применяются только явно заданные значения. Пустые поля и наследуемые переключатели не изменяют существующие файлы Auth.",
  "ui.save_global_policy": "Сохранить глобальную конфигурацию",
  "ui.global_policy_override_status": "Состояние глобальной политики",
  "ui.global_basics_group": "Базовые настройки аккаунта",
  "ui.global_basics_group_help": "Состояние, отключение, приоритет, параллельность и примечания.",
  "ui.routing_group": "Маршрутизация и транспорт",
  "ui.routing_group_help": "Настройте маршрут, прокси и WebSockets по умолчанию.",
  "ui.quota_group": "Ограничения квоты",
  "ui.quota_group_help": "Необязательные ограничения на 5 часов и 7 дней; пустые поля сохраняют текущие значения.",
  "ui.request_policy_group": "Политика запросов и моделей",
  "ui.request_policy_group_help": "Изменение заголовков и списки разрешённых или запрещённых моделей.",
  "ui.codex_identity_group": "Совместимость идентичности Codex",
  "ui.codex_identity_group_help": "Единственная глобальная конфигурация идентичности клиента Codex: исходящая сходимость и входные ворота официальных клиентов задаются здесь, а автоматические политики только наследуют её и не хранят копию.",
  "ui.codex_identity_single_source_note": "Это единственный глобальный редактор. Отдельная учетная запись или провайдер может явно переопределить его в своей политике идентичности; выбор наследования возвращает значение отсюда.",
  "ui.default_policy_heading": "Настройки автоматизации по умолчанию",
  "ui.default_policy_description": "Управляет плановым сканированием и действиями политики автоматизации по умолчанию.",
  "ui.default_policy_help": "Здесь настраивается автоматизация; значения конфигурации аккаунта и провайдера задаются выше отдельно.",
  "ui.automation_runtime_group": "Среда автоматизации",
  "ui.automation_runtime_group_help": "Укажите, запускается ли политика и как проверяются новые аккаунты.",
  "ui.default_account_proxy_profile": "Пресет прокси аккаунта по умолчанию",
  "ui.default_ai_provider_proxy_profile": "Пресет прокси AI-провайдера по умолчанию",
  "ui.proxy_profiles_usage_help": "Пресеты прокси хранят переиспользуемые адреса и скрывают учетные данные в интерфейсе. Автоматизация и массовое редактирование используют пресет, не показывая и не подставляя секрет прокси.",
  "ui.global_proxy_profile_help": "Это глобальные значения по умолчанию. Условная политика может отдельно переопределить прокси аккаунта и AI-провайдера; пустое значение ничего не меняет.",
  "ui.conditional_proxy_profile_help": "Действия с прокси переопределяют глобальные значения. Прокси аккаунта и AI-провайдера независимы и могут оставаться без изменений.",
  ...
  "ui.automation_actions": "Действия автоматизации",
  ...
  "ui.edit_ai_provider": "Изменить канал",
  "ui.ai_provider_added": "AI-провайдер добавлен",
  "ui.ai_provider_saved": "Канал сохранён",
  ...
  "ui.more_actions_for_provider": "Дополнительные действия для провайдера {provider}",
  "ui.provider_more_actions": "Дополнительные действия провайдера",
  ...
  "ui.ai_provider_field_display_name": "Отображаемое имя",
  "ui.ai_provider_field_force_mapping": "Принудительное сопоставление",
  "ui.ai_provider_field_is_compat": "Совместимость",
  "ui.ai_provider_field_image": "Изображение",
  "ui.ai_provider_field_add_model": "+ Добавить модель",
  "ui.ai_provider_fetch_models": "Получить модели",
  "ui.ai_provider_fetching_models": "Получение моделей…",
  "ui.ai_provider_models_fetched": "Получено моделей: {count}",
  "ui.ai_provider_fetch_models_failed": "Не удалось получить модели; существующие модели сохранены",
  "ui.ai_provider_field_api_key_entries": "API-ключи",
  ...
  "ui.enable_ai_provider": "Включить этот канал",
  "ui.disable_ai_provider": "Отключить этот канал",
  "ui.delete_ai_provider": "Удалить этот канал",
  "ui.ai_provider_enabled": "Канал включён",
  "ui.ai_provider_disabled_notice": "Канал отключён",
  "ui.ai_provider_test_ok": "Канал доступен",
  "ui.ai_provider_test_failed": "Канал недоступен",
  "ui.testing_ai_provider": "Проверка доступности канала…",
  "ui.excluded_models": "Исключённые модели",
  "ui.edit": "Изменить",
  "ui.save": "Сохранить",
  "ui.models": "моделей",
  ...
  "ui.ai_provider_concurrency_active_short": "Параллельность {value}",
  "ui.ai_provider_concurrency_request_short": "Запросы за {seconds} с: {value}",
  "ui.ai_provider_concurrency_queue_short": "Очередь {value}",
  "ui.ai_provider_concurrency_window_seconds": "Окно запросов (секунды)",
  "ui.ai_provider_concurrency_request_limit": "Лимит окна запросов",
  ...
  "ui.ai_provider_runtime_unavailable": "Метрики недоступны",
  "ui.ai_provider_model": "Модель",
  "ui.ai_provider_input_tokens": "Входные токены",
  "ui.ai_provider_output_tokens": "Выходные токены",
  "ui.ai_provider_total": "Всего",
  "ui.ai_provider_cost": "Стоимость",
  "ui.ai_provider_unlimited_concurrency": "Без ограничений",
  ...
  "ui.ai_provider_quota_settings_description": "CPA не предоставляет официальные общие квоты провайдера за 5 часов/7 дней. Проценты рассчитываются по оценённым плагином расходам в USD и заданному бюджету; параллельность также может быть только наблюдаемой.",
  "ui.ai_provider_budget_amount": "Бюджет (USD)",
  ...
  "ui.risk_control_center": "Центр управления рисками",
  "ui.risk_control_title": "Контроль риска запросов",
  "ui.risk_control_description": "Проверяйте настраиваемые сигналы до отправки провайдеру; исходный текст промпта не сохраняется.",
  "ui.risk_status_inactive": "Политика выключена",
  "ui.risk_status_blocking": "Блокировка включена",
  "ui.risk_status_observing": "Наблюдение включено",
  "ui.risk_control_load_failed": "Не удалось загрузить данные риск-контроля.",
  "ui.risk_control_save_failed": "Не удалось сохранить настройки риск-контроля.",
  "ui.risk_control_saved": "Настройки риск-контроля сохранены.",
  "ui.risk_control_clear_failed": "Не удалось очистить данные риск-контроля.",
  "ui.risk_control_events_cleared": "События риск-контроля очищены.",
  "ui.risk_control_hashes_cleared": "Запомненные хэши очищены.",
  "ui.risk_control_storage_warning": "Постоянное хранилище риск-контроля недоступно или некорректно.",
  "ui.risk_total_events": "Всего событий",
  "ui.risk_events_retained": "Сохранённые обезличенные события",
  "ui.risk_blocked": "Заблокировано",
  "ui.risk_prevented_requests": "Предотвращённые запросы",
  "ui.risk_observed": "Наблюдалось",
  "ui.risk_observe_only": "Совпадения только для наблюдения",
  "ui.risk_remembered_hashes": "Запомненные хэши",
  "ui.risk_hash_reuse": "Повторно используемые отпечатки",
  "ui.risk_policy_settings": "Настройки политики",
  "ui.risk_policy_settings_description": "Настройте локальные ключевые слова и хэш-контроль для выбранных моделей.",
  "ui.risk_enabled": "Включить риск-контроль",
  "ui.risk_mode": "Режим работы",
  "ui.risk_mode_off": "Выключен",
  "ui.risk_mode_observe": "Только наблюдение",
  "ui.risk_mode_pre_block": "Предварительная блокировка",
  "ui.risk_blocked_keywords": "Блокируемые ключевые слова",
  "ui.risk_keywords_placeholder": "Одно слово или фраза на строку",
  "ui.risk_keywords_hint": "В событиях хранятся только нормализованные ссылки на правила.",
  "ui.risk_model_filter": "Фильтр моделей",
  "ui.risk_model_filter_all": "Все модели",
  "ui.risk_model_filter_include": "Только модели из списка",
  "ui.risk_model_filter_exclude": "Исключить модели из списка",
  "ui.risk_model_list": "Список моделей",
  "ui.risk_hash_check": "Запоминать хэши ввода",
  "ui.risk_block_status": "HTTP-код блокировки",
  "ui.risk_block_message": "Сообщение блокировки",
  "ui.risk_retention_days": "Хранение событий (дни)",
  "ui.risk_max_events": "Максимум событий",
  "ui.risk_safety_boundary": "Граница безопасности",
  "ui.risk_safety_boundary_description": "Плагин хранит только метаданные и отпечатки; тела запросов, учётные данные и заголовки не попадают в журнал.",
  "ui.risk_safe_point_1": "Текст промпта обрабатывается в памяти и не сохраняется.",
  "ui.risk_safe_point_2": "Идентификаторы аккаунтов псевдонимизируются односторонней ссылкой SHA-256.",
  "ui.risk_safe_point_3": "События используют ссылки на правила и усечённые хэши вместо чувствительных данных.",
  "ui.risk_memory_management": "Управление данными",
  "ui.risk_memory_management_description": "Очистите сохранённые события или повторно используемые отпечатки.",
  "ui.risk_clear_hashes": "Очистить хэши",
  "ui.risk_clear_events": "Очистить события",
  "ui.risk_event_history": "История событий",
  "ui.risk_event_history_description": "Последние обезличенные совпадения, сначала новые.",
  "ui.risk_event_time": "Время",
  "ui.risk_event_action": "Действие",
  "ui.risk_event_source": "Источник",
  "ui.risk_event_model": "Модель",
  "ui.risk_event_rule": "Ссылка на правило",
  "ui.risk_event_hash": "Хэш ввода",
  "ui.risk_event_latency": "Задержка",
  "ui.risk_no_events": "События риск-контроля отсутствуют.",
  "ui.risk_action_keyword_observe": "Ключевое слово замечено",
  "ui.risk_action_keyword_block": "Ключевое слово заблокировано",
  "ui.risk_action_hash_observe": "Хэш замечен",
  "ui.risk_action_hash_block": "Хэш заблокирован",
  "ui.risk_modules": "Модули риск-контроля",
  "ui.risk_modules_description": "Выберите независимый модуль аудита; у каждого свои очередь, тайм-аут и политика ошибок.",
  "ui.risk_content_moderation": "Модерация контента",
  "ui.risk_prompt_audit": "Аудит промптов",
  "ui.risk_custom_audit": "Пользовательский аудит",
  "ui.risk_prompt_audit_title": "Аудит промптов",
  "ui.risk_prompt_audit_description": "Отправляет последний запрос пользователя на внешний endpoint через ограниченную обезличенную очередь.",
  "ui.risk_custom_audit_title": "Пользовательский аудит",
  "ui.risk_custom_audit_description": "Использует системный промпт команды и порог уверенности для политики аудита.",
  "ui.risk_audit_enabled": "Включить модуль аудита",
  "ui.risk_audit_mode": "Режим аудита",
  "ui.risk_audit_endpoint": "Endpoint аудита",
  "ui.risk_audit_model": "Модель аудита",
  "ui.risk_audit_model_source": "Источник модели аудита",
  "ui.risk_audit_source_external": "Внешний сервис аудита",
  "ui.risk_audit_source_account": "Модель CPA-аккаунта",
  "ui.risk_audit_source_provider": "Модель AI-провайдера",
  "ui.risk_audit_account": "CPA-аккаунт",
  "ui.risk_audit_provider": "Канал AI-провайдера",
  "ui.risk_audit_select_account": "Выберите аккаунт",
  "ui.risk_audit_select_provider": "Выберите канал провайдера",
  "ui.risk_audit_select_model": "Выберите модель",
  "ui.risk_audit_loading_models": "Загрузка моделей аккаунта…",
  "ui.risk_audit_native_credential_hint": "Используются существующие учетные данные CPA; дополнительный API-ключ не сохраняется.",
  "ui.risk_audit_credential_env": "Переменная окружения с ключом",
  "ui.risk_audit_credential_env_hint": "Сохраняется только имя переменной; секрет остаётся в окружении.",
  "ui.risk_audit_scanners": "Метки сканеров",
  "ui.risk_audit_scanners_placeholder": "cyber_abuse\naccount_abuse",
  "ui.risk_audit_latest_turn_only": "Проверять только последний запрос",
  "ui.risk_audit_store_pass_events": "Сохранять события пропуска",
  "ui.risk_audit_timeout": "Тайм-аут (мс)",
  "ui.risk_audit_input_limit": "Лимит ввода (байт)",
  "ui.risk_audit_workers": "Рабочие",
  "ui.risk_audit_queue_capacity": "Ёмкость очереди",
  "ui.risk_audit_failure_policy": "Политика ошибки",
  "ui.risk_audit_fail_open": "Пропускать при ошибке",
  "ui.risk_audit_fail_closed": "Блокировать при ошибке",
  "ui.risk_custom_confidence": "Порог уверенности",
  "ui.risk_custom_system_prompt": "Пользовательский системный промпт",
  "ui.risk_audit_active": "Активен",
  "ui.risk_audit_queue": "Очередь",
  "ui.risk_audit_processed": "Обработано",
  "ui.risk_audit_blocked": "Заблокировано",
  "ui.risk_audit_errors": "Ошибки",
  "ui.risk_audit_credential": "Ключ",
  "ui.risk_audit_credential_ready": "Готов",
  "ui.risk_audit_credential_missing": "Отсутствует",
  "ui.risk_audit_credential_unset": "Не настроен",
  "ui.risk_audit_status_unavailable": "Статус модуля недоступен",

  "ui.risk_control": "Центр риск-контроля",
  "ui.risk_audit": "Аудит промптов",
  "ui.risk_events_cleared": "События риск-контроля очищены.",
  "ui.risk_hashes_cleared": "Сохранённые хэши очищены.",
  "ui.risk_control_action_failed": "Операция риск-контроля не выполнена.",
  "ui.risk_audit_api_key": "API-ключ",
  "ui.risk_audit_api_key_hint": "Введите API-ключ сервиса аудита напрямую. Плагин использует его в памяти и не читает переменные окружения.",
  "ui.risk_audit_api_key_configured_hint": "API-ключ настроен; его значение не отображается. Оставьте поле пустым, чтобы сохранить текущий ключ.",
  "ui.risk_audit_api_key_placeholder": "Настроен; введите новое значение для замены",
  "ui.risk_audit_api_key_clear": "Очистить API-ключ",
  "ui.risk_audit_api_key_ready": "Готов",
  "ui.risk_audit_api_key_unavailable": "Настроен, но недоступен",
  "ui.risk_audit_api_key_unset": "Не настроен",
  "ui.risk_audit_cpa_model": "Модель CPA",
  "ui.risk_audit_cpa_model_ready": "Готов",
  "ui.risk_audit_cpa_model_unavailable": "Настроен, но недоступен",
  "ui.risk_audit_cpa_model_unset": "Не настроен",
  "ui.risk_prompt_list": "Список системных промптов",
  "ui.risk_prompt_add": "Добавить промпт",
  "ui.risk_prompt_delete": "Удалить промпт",
  "ui.risk_prompt_name": "Название промпта",
  ...
  "ui.risk_action_audit_block": "Аудит: блокировка",
  "ui.risk_action_error_block": "Блокировка из-за ошибки аудита",
  "ui.risk_action_audit_pass": "Аудит пройден",
  "ui.self_update_title": "Прямое самообновление с GitHub",
  "ui.self_update_description": "Обновляет плагин напрямую из его релизов на GitHub и не зависит от магазина плагинов CPA.",
  "ui.self_update_source": "Источник обновления",
  "ui.self_update_source_api": "GitHub API",
  "ui.self_update_source_redirect": "Перенаправление релиза GitHub",
  "ui.self_update_source_atom": "Лента релизов GitHub",
  "ui.self_update_source_unknown": "Ещё не определён",
  "ui.self_update_asset": "Файл релиза",
  "ui.self_update_asset_size": "Размер файла",
  "ui.self_update_library_file": "Файл библиотеки плагина",
  "ui.self_update_library_not_located": "Не найден автоматически",
  "ui.self_update_library_detected_via": "Определён {source}.",
  "ui.self_update_library_hint": "Укажите путь к библиотеке плагина, если автоматическое определение на этом хосте недоступно.",
  "ui.self_update_library_missing": "Записанный файл библиотеки плагина не существует; исправьте путь перед установкой.",
  "ui.self_update_file_source_setting": "из сохранённой настройки",
  "ui.self_update_file_source_process": "из образа запущенного процесса",
  "ui.self_update_file_source_search": "из поиска в каталоге плагинов",
  "ui.self_update_file_source_unknown": "из неизвестного источника",
  "ui.self_update_checksum_verified": "Контрольная сумма релиза проверена",
  "ui.self_update_installed_version": "Установлена версия {version}; ожидается перезапуск CPA",
  "ui.self_update_restart_required": "Перезапустите CPA, чтобы загрузить обновлённую библиотеку плагина.",
  "ui.self_update_backup_at": "Предыдущая библиотека сохранена в {path}",
  "ui.self_update_storage_error": "Состояние самообновления не удалось сохранить.",
  "ui.self_update_save_path": "Сохранить путь",
  "ui.self_update_restart_hint": "Библиотека плагина уже загружена в процесс CPA, поэтому замена вступит в силу после перезапуска.",
  "ui.self_update_check": "Проверить релизы GitHub",
  "ui.self_update_download_manually": "Открыть файл релиза",
  "ui.self_update_install": "Скачать и установить",
  "ui.self_update_found_version": "На GitHub доступен релиз {version}.",
  ...
  "ui.codex_test_channel_suffix": "канал AI-провайдера",
  "ui.codex_test_no_targets": "Нет учётной записи Codex или канала AI-провайдера для проверки. Настройте его на странице AI-провайдеров и повторите.",
  "ui.model_test_endpoint": "Протокол",
  "ui.model_test_endpoint_tried": "испробовано: {list}",
  ...
  "ui.self_update_reload_waiting": "Запрашиваем у CPA переустановку и перезагрузку плагина; во время замены соединение может оборваться, поэтому ожидаем ответ новой версии.",
  "ui.self_update_reload_not_confirmed": "Перезагрузка не подтверждена за 90 секунд: CPA мог не перезагрузить плагин (магазин недоступен или запрос истёк). Повторите попытку или перезапустите CPA.",
  "ui.self_update_reload_without_restart": "Перезагрузить без перезапуска",
  "ui.self_update_reload_hint": "CPA перезагружает нативный плагин после установки из магазина, поэтому здесь мы просим CPA переустановить этот плагин на месте. Если магазин недоступен, перезапуск CPA остаётся единственным способом загрузить новую библиотеку.",
  "ui.self_update_reloaded_refresh_page": "CPA перезагрузил плагин: новая версия уже действует на этой странице.",
  "ui.self_update_reload_failed": "Перезагрузка отклонена, причина ниже.",
  "ui.self_update_reload_last_result": "Результат последней перезагрузки: {reason}",
  "ui.self_update_reload_store_unavailable": "Магазин плагинов CPA недоступен, перезагрузка не запускалась.",
  "ui.self_update_reload_store_disabled": "Магазин плагинов CPA отключён, перезагрузка не запускалась.",
  "ui.self_update_reload_not_in_store": "Этого плагина нет в магазине CPA, переустанавливать нечего.",
  "ui.self_update_reload_store_version_unknown": "Магазин CPA не сообщил версию этого плагина.",
  "ui.self_update_reload_store_older": "Магазин CPA предлагает версию старее уже записанной, поэтому перезагрузка отклонена во избежание отката.",
  "ui.self_update_reload_install_failed": "CPA не смог переустановить плагин из магазина (ошибка загрузки или проверки контрольной суммы).",
  "ui.self_update_reload_management_unavailable": "Management API CPA недоступен из плагина, запросить перезагрузку не удалось.",
  "ui.self_update_reload_restart_still_required": "CPA переустановил плагин, но по-прежнему требует перезапуска.",
  "ui.model_id_is_invalid": "Идентификатор модели недействителен.",
  "ui.upstream_detail": "Ответ апстрима",
  "ui.opencode_probe_go_auth_failed_hint": "Шлюз Go отклонил этот API-ключ (401). Ключи Go и Zen различаются: убедитесь, что ключ принадлежит этому рабочему пространству Go и не был заменён. Сохраните актуальный ключ на вкладке Go и проверьте снова.",
  "ui.opencode_probe_zen_auth_failed_hint": "Шлюз Zen отклонил этот API-ключ (401). Проверьте, что ключ по-прежнему активен для этого рабочего пространства и не был заменён, затем сохраните его снова на вкладке Zen.",
  ...
  "ui.model_test_no_credentials": "Пока нет данных доступа для этой проверки. Сначала добавьте их на вкладке учётных записей и загрузите каталог моделей.",
  "ui.model_test_fallback_credentials": "Модели нет ни в одном кэшированном каталоге, поэтому предложены все данные доступа этого семейства: выберите одни и проверьте напрямую.",
  "ui.self_update_interface_updated": "Интерфейс из этого релиза уже активен: обновите страницу. Библиотеке плагина всё ещё нужен перезапуск CPA.",
  ...
  "ui.opencode_edit_credentials": "Изменить данные доступа",
  "ui.opencode_edit_credentials_for": "Изменить данные доступа {account}",
  "ui.opencode_credentials_keep": "Оставьте пустым, чтобы сохранить значение",
  "ui.opencode_credentials_keep_hint": "Пустое поле сохраняет прежнее значение. Workspace ID и auth cookie нужны для панели квоты; API-ключ необходим для каталога моделей, тестов моделей и маршрутизации через CPA.",
  "ui.opencode_credentials_saved": "Данные доступа обновлены",
  "ui.opencode_cookie_missing": "Нет auth cookie",
  "ui.opencode_incomplete_credentials": "Неполные данные доступа: без API-ключа плагин не может прочитать каталог моделей, протестировать модель или направить её через CPA.",
  "ui.overview_usage_tokens": "Ввод {input} · вывод {output} · кэш {cached} токенов",
  "ui.overview_requests": "Запросы",
  "ui.overview_used_allowance": "Использованная квота",
  "ui.overview_usage_requests": "Запросы: {requests}",
  "ui.overview_usage_amount_note": "Справочная сумма по таблице цен плагина, а не фактическая плата.",
  "ui.overview_quota_window_note": "Наибольшее использование среди {count} учетных данных, сообщивших это окно.",
  "ui.opencode_balance_note": "OpenCode сообщает только доли квоты: здесь показан остаток самого нагруженного окна, а не баланс в USD.",
  "ui.cline_pass_used": "Использовано относительно подписки {subscription} по справочным тарифам документации",
  "ui.cline_pass_counts_bound": "Аккаунты, привязанные к каналу CPA",
  "ui.cline_pass_counts_models": "Модели Cline Pass",
  "ui.auto_retry_title": "Автоматический повтор",
  "ui.auto_retry_description": "Плагин повторяет запросы к вышестоящему сервису в пределах этого лимита; повторы прозрачны для клиента.",
  "ui.auto_retry_attempts": "Число повторов",
  "ui.auto_retry_attempts_unit": "раз",
  "ui.auto_retry_attempts_hint": "0 отключает повторы; максимум — {max}.",
  "ui.auto_retry_attempts_invalid": "Введите целое число от 0 до {max}.",
  "ui.auto_retry_disabled_state": "Выключено (без повторов)",
  "ui.auto_retry_enabled_state": "До {value} автоматических повторов",
  "ui.auto_retry_save": "Сохранить настройку повторов",
  "ui.auto_retry_saved": "Настройка автоматических повторов сохранена",
  "ui.auto_retry_save_failed": "Не удалось сохранить настройку автоматических повторов.",
  "ui.auto_retry_load_failed": "Не удалось загрузить настройку автоматических повторов.",
  "ui.auto_retry_host_state": "Предусловия хоста",
  "ui.auto_retry_host_request_retry": "Повторы запросов хоста: {value}",
  "ui.auto_retry_host_max_interval": "Максимальный интервал повторов: {value} с",
  "ui.auto_retry_host_max_credentials": "Максимум учетных данных на повтор: {value}",
  ...
  "ui.auto_retry_not_reported": "Пока не сообщено",
