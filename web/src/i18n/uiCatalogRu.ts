...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.codex_settings_moved_note": "Политика идентичности Codex настраивается в разделе Codex. Эксперименты недельного овердрафта и Agent Identity остаются здесь.",
  ...
  "ui.self_update_reloaded_refresh_page": "CPA перезагрузил плагин: обновите эту страницу, чтобы использовать новую версию.",
